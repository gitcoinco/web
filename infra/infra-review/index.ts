...
//////////////////////////////////////////////////////////////
// Upload static ressources
//////////////////////////////////////////////////////////////

// TODO: this is slow, use this instead: `aws s3 sync static s3://$(pulumi stack output bucketName)/static --acl public-read`
// let staticRoot = "static"; // directory for content files

// function uploadFilesToBucket(folder: string) {
//     // For each file in the directory, create an S3 object stored in `siteBucket`
//     for (let item of fs.readdirSync(folder)) {
//         let filePath = path.join(folder, item);
//         pulumi.log.info("filePath: " + filePath)
//         if (fs.statSync(filePath).isDirectory()) {
//             pulumi.log.info("    is folder")
//             uploadFilesToBucket(filePath);
//         } else {
//             pulumi.log.info("    is file")
...
// uploadFilesToBucket(staticRoot)
...
// export const vpcPublicSubnets11 = vpcPublicSubnets1.then((v) => {
//     console.log("GERI v: ", v);
//     return v;
// });

// export const vpcPublicSubnets111 = vpcPublicSubnets11.then();
...
// vpc.getSubnets("public").then((subnets) => {
//     subnets[0].routeTable.
// })

// export const s  = vpc.;
// export const subnets  = vpc.getSubnets("private");

const cluster = new awsx.ecs.Cluster("gitcoin", { vpc });
// export const clusterSecurityGroups = cluster.securityGroups.map((sg) );


const listener = new awsx.lb.ApplicationListener("app", { port: 80, vpc });
// const lb = new awsx.lb.ApplicationLoadBalancer("gitcoin-alb", {});

const eip = aws.ec2.Eip.get("gitcoin-review-public-IP", "eipalloc-025fbd75fcaafe175");  // TODO: config this


export const publicEipAddress = eip.address;
export const publicEipDomain = eip.domain;
export const publicEipId = eip.id;
export const publicEip = eip;
...
export const lbId = example.id;
// const listener = networkLoadBalancer.createListener("listener-app-service", { port: 80 });
// export const nlbListeners = networkLoadBalancer.listeners;
// export const nlbTargetGroups = networkLoadBalancer.targetGroups;
...
// const ec2SubnetId: Promise< pulumi.Output<string> > = vpcSubnets.then((subnets) => { return subnets[0] });
