describe('Creating a new bounty', { tags: ['bounties'] }, () => {
  ...
  describe('Verify bounty field validation', () => {
    it.skip('Should validated the mandatory fields on screen 1 ', () => {
      cy.visit('bounty/new');
      ...
      // Screen 5
      // Clicking 'Confirm' should trigger the validation
      cy.contains('Confirm').click();
    ...
    it.skip('Should validated that bounty information source was selected on screen 2 ', () => {
      cy.visit('bounty/new');
      cy.wait(1000);
