!function(e, t) {
  ...
  return function(e) {
    ...
    function n(r) {
      if (t[r])
        return t[r].exports; var i = t[r] = {i: r, l: !1, exports: {}};
    ...
    o.consoleTransport = console; var r = [o.consoleTransport];
    ...
    function s() {
      var e = arguments[0]; var t = arguments[1]; var s = Array.prototype.slice.call(arguments, 2);

      if (!(n[t] < e.level))
        for (var o = !(e.options.disableCallerInfo || i.disableCallerInfo) && function() {
              var e = {methodName: '', fileLocation: '', line: null, column: null}; var t = new Error; var n = t.stack ? t.stack.split('\n') : [];
          ...
          if (l && 'function' == typeof l) {
            ...
            h.push((new Date).toISOString()), e.id && h.push('[' + e.id + ']'), o && o.methodName.length > 1 && h.push('<' + o.methodName + '>: '); var d = h.concat(s);

            l.bind(u).apply(u, d);
          }
        }
    } function o(e, t, r, i) {
      this.id = t, this.options = i || {}, this.transports = r, this.transports || (this.transports = []), this.level = n[e]; for (var o = Object.keys(n), a = 0; a < o.length; a++)
        this[o[a]] = s.bind(null, this, o[a]);
    }o.setGlobalOptions = function(e) {
      i = e || {};
    }, o.prototype.setLevel = function(e) {
      this.level = n[e];
    }, e.exports = o, o.levels = {TRACE: 'trace', DEBUG: 'debug', INFO: 'info', LOG: 'log', WARN: 'warn', ERROR: 'error'};
  }, function(e, t, n) {
    'use strict'; var r; var i = 'object' == typeof Reflect ? Reflect : null; var s = i && 'function' == typeof i.apply ? i.apply : function(e, t, n) {
    ...
    function a() {
      a.init.call(this);
    }e.exports = a, a.EventEmitter = a, a.prototype._events = void 0, a.prototype._eventsCount = 0, a.prototype._maxListeners = void 0; var c = 10;

    function u(e) {
      return void 0 === e._maxListeners ? a.defaultMaxListeners : e._maxListeners;
    } function l(e, t, n, r) {
      var i; var s; var o; var a;

      if ('function' != typeof n)
        throw new TypeError('The "listener" argument must be of type Function. Received type ' + typeof n); if (void 0 === (s = e._events) ? (s = e._events = Object.create(null), e._eventsCount = 0) : (void 0 !== s.newListener && (e.emit('newListener', t, n.listener ? n.listener : n), s = e._events), o = s[t]), void 0 === o)
        o = s[t] = n, ++e._eventsCount; else if ('function' == typeof o ? o = s[t] = r ? [ n, o ] : [ o, n ] : r ? o.unshift(n) : o.push(n), (i = u(e)) > 0 && o.length > i && !o.warned) {
        o.warned = !0; var c = new Error('Possible EventEmitter memory leak detected. ' + o.length + ' ' + String(t) + ' listeners added. Use emitter.setMaxListeners() to increase limit');

        c.name = 'MaxListenersExceededWarning', c.emitter = e, c.type = t, c.count = o.length, a = c, console && console.warn && console.warn(a);
      } return e;
    } function h() {
      for (var e = [], t = 0; t < arguments.length; t++)
        e.push(arguments[t]); this.fired || (this.target.removeListener(this.type, this.wrapFn), this.fired = !0, s(this.listener, this.target, e));
    } function d(e, t, n) {
      var r = {fired: !1, wrapFn: void 0, target: e, type: t, listener: n}; var i = h.bind(r);
      ...
      if ('number' != typeof e || e < 0 || o(e))
        throw new RangeError('The value of "defaultMaxListeners" is out of range. It must be a non-negative number. Received ' + e + '.'); c = e;
    }}), a.init = function() {
      ...
      for (var t = [], n = 1; n < arguments.length; n++)
        t.push(arguments[n]); var r = 'error' === e; var i = this._events;

      if (void 0 !== i)
        r = r && void 0 === i.error; else if (!r)
        return !1; if (r) {
        var o;

        if (t.length > 0 && (o = t[0]), o instanceof Error)
          throw o; var a = new Error('Unhandled error.' + (o ? ' (' + o.message + ')' : ''));
      ...
      if ('function' != typeof t)
        throw new TypeError('The "listener" argument must be of type Function. Received type ' + typeof t); return this.on(e, d(this, e, t)), this;
    }, a.prototype.prependOnceListener = function(e, t) {
      if ('function' != typeof t)
        throw new TypeError('The "listener" argument must be of type Function. Received type ' + typeof t); return this.prependListener(e, d(this, e, t)), this;
    }, a.prototype.removeListener = function(e, t) {
      var n; var r; var i; var s; var o;

      if ('function' != typeof t)
        throw new TypeError('The "listener" argument must be of type Function. Received type ' + typeof t); if (void 0 === (r = this._events))
        return this; if (void 0 === (n = r[e]))
        return this; if (n === t || n.listener === t)
        0 == --this._eventsCount ? this._events = Object.create(null) : (delete r[e], r.removeListener && this.emit('removeListener', e, n.listener || t)); else if ('function' != typeof n) {
        for (i = -1, s = n.length - 1; s >= 0; s--)
          if (n[s] === t || n[s].listener === t) {
            o = n[s].listener, i = s; break;
          } if (i < 0)
          return this; 0 === i ? n.shift() : function(e, t) {
          for (;t + 1 < e.length; t++)
            e[t] = e[t + 1]; e.pop();
      ...
      if (void 0 === (n = this._events))
        ...
        var i; var s = Object.keys(n);

        for (r = 0; r < s.length; ++r)
          'removeListener' !== (i = s[r]) && this.removeAllListeners(i); return this.removeAllListeners('removeListener'), this._events = Object.create(null), this._eventsCount = 0, this;
      } if ('function' == typeof (t = n[e]))
        this.removeListener(e, t); else if (void 0 !== t)
        for (r = t.length - 1; r >= 0; r--)
          this.removeListener(e, t[r]); return this;
    ...
    e.exports = function(e) {
      var t; var n = e.scope; var r = e.window; var i = e.windowForEventListening || window; var s = {}; var o = []; var a = {}; var c = !1; var u = function(e) {
        var t;
        ...
        try {
          ...
          if (r)
            for (var i = 0; i < r.length; i++)
              r[i].call(null, t.params); else
            a[t.method] = a[t.method] || [], a[t.method].push(t.params);
        }
      };

      i.addEventListener('message', u, !1); var l = {listen: function(e, t) {
        s[e] = s[e] || [], s[e].push(t); var n = a[e];

        if (n)
          for (var r = s[e], i = 0; i < r.length; i++)
            for (var o = 0; o < n.length; o++)
              r[i].call(null, n[o]); delete a[e];
      }, send: function(e) {
        var t = e.method;
      ...
      }}; var h = +new Date + Math.random() + '';

      return t = setInterval((function() {
        l.send({method: '__ready__', params: h});
      }), 50), l.listen('__ready__', (function(e) {
        if (e === h) {
          clearInterval(t), c = !0; for (var n = 0; n < o.length; n++)
            l.send(o[n]); o = [];
        } else
          l.send({method: '__ready__', params: e});
      })), l;
    };
  }, function(e) {
    e.exports = {'google-auth': {matchPatterns: {url: 'accounts.google.com'}, target: 'electron'}, 'dropbox-auth': {matchPatterns: {url: 'dropbox.com/oauth2/authorize'}, target: 'electron'}};
  }, function(e, t, n) {
    var r = n(1); var i = n(7); var s = {}; var o = []; var a = r.levels.TRACE;

    e.exports = {addGlobalTransport: function(e) {
    ...
    function i(e, t) {
      ...
      var e = arguments[1]; var t = this.formatLogMessage.apply(this, arguments);

      if (t) {
        var n = this.queue[this.queue.length - 1]; var r = n && n.text;
    ...
    'use strict'; n.r(t); var r = n(2); var i = n.n(r); const s = 'org.jitsi.meet:'; const o = '(//[^/?#]+)'; const a = '([^?#]*)'; const c = '^([a-z][a-z0-9\\.\\+-]*:)';

    function u(e) {
      const t = new RegExp(`${c}+`, 'gi'); const n = t.exec(e);
      ...
      const t = {toString: d}; let n; let r; let i;
      ...
      if (e = e.replace(/\s/g, ''), (r = (n = new RegExp(c, 'gi')).exec(e)) && (t.protocol = r[1].toLowerCase(), e = e.substring(n.lastIndex)), r = (n = new RegExp(`^${o}`, 'gi')).exec(e)) {
        ...
        e = e.substring(n.lastIndex); const s = i.indexOf('@');

        -1 !== s && (i = i.substring(s + 1)), t.host = i; const o = i.lastIndexOf(':');
        ...
        t.search = ''; return t.hash = e.startsWith('#') ? e : '', t;
    } function d(e) {
      const {hash: t, host: n, pathname: r, protocol: i, search: s} = e || this; let o = '';

      return i && (o += i), n && (o += `//${n}`), o += r || '/', s && (o += s), t && (o += t), o;
    } function p(e) {
      let t; const n = h(u(t = e.serverURL && e.room ? new URL(e.room, e.serverURL).toString() : e.room ? e.room : e.url || ''));
      ...
      if (!n.host) {
        ...
        if (t) {
          const {host: e, hostname: i, pathname: o, port: a} = h(u(`${s}//${t}`));

          e && (n.host = e, n.hostname = i, n.port = a), '/' === r && '/' !== o && (r = o);
        }
      } const i = e.roomName || e.room;

      !i || !n.pathname.endsWith('/') && n.pathname.endsWith(`/${i}`) || (r.endsWith('/') || (r += '/'), r += i), n.pathname = r; const {jwt: o} = e;

      if (o) {
        let {search: e} = n;

        -1 === e.indexOf('?jwt=') && -1 === e.indexOf('&jwt=') && (e.startsWith('?') || (e = `?${e}`), 1 === e.length || (e += '&'), e += `jwt=${o}`, n.search = e);
      } let {hash: a} = n;
      ...
      const r = 'search' === n ? e.search : e.hash; const i = {}; const s = r && r.substr(1).split('&') || [];
    ...
    }(window.location).jitsi_meet_external_api_id; var v = n(3); var m = n.n(v);

    function g(e, t, n) {
      return t in e ? Object.defineProperty(e, t, {value: n, enumerable: !0, configurable: !0, writable: !0}) : e[t] = n, e;
    } const y = {window: window.opener || window.parent}; const b = 'message';

    class _ {
      constructor({postisOptions: e} = {}) {
        this.postis = m()(function(e) {
          for (var t = 1; t < arguments.length; t++) {
            var n = null != arguments[t] ? arguments[t] : {}; var r = Object.keys(n);
        ...
        this.postis.send({method: b, params: e});
      }setReceiveCallback(e) {
        this._receiveCallback = e;
      }
    } const w = 'event'; const L = 'request'; const O = 'response';
    ...
    class x {
      constructor({backend: e} = {}) {
        ...
        if (e.type === O) {
          ...
          e.type === L ? this.emit('request', e.data, (t, n)=>{
            this._backend.send({type: O, error: n, id: e.id, result: t});
        ...
        this._backend && this._backend.send({type: w, data: e});
      }sendRequest(e) {
        if (!this._backend)
          return Promise.reject(new Error('No transport backend defined!')); this._requestID++; const t = this._requestID;

        return new Promise((n, r)=>{
          this._responseHandlers.set(t, ({error: e, result: t})=>{
            void 0 !== t ? n(t) : r(void 0 !== e ? e : new Error('Unexpected response format!'));
          }), this._backend.send({type: L, data: e, id: t});
        });
      }setBackend(e) {
    ...
    function I(e, t) {
      if (null == e)
        return {}; var n; var r; var i = function(e, t) {
        if (null == e)
          return {}; var n; var r; var i = {}; var s = Object.keys(e);

        for (r = 0; r < s.length; r++)
          n = s[r], t.indexOf(n) >= 0 || (i[n] = e[n]); return i;
      }(e, t);
      ...
      return $;
    })); const R = [ 'css/all.css', 'libs/alwaysontop.min.js' ]; const P = {avatarUrl: 'avatar-url', displayName: 'display-name', email: 'email', hangup: 'video-hangup', password: 'password', sendTones: 'send-tones', subject: 'subject', submitFeedback: 'submit-feedback', toggleAudio: 'toggle-audio', toggleChat: 'toggle-chat', toggleFilmStrip: 'toggle-film-strip', toggleShareScreen: 'toggle-share-screen', toggleTileView: 'toggle-tile-view', toggleVideo: 'toggle-video'}; const N = {'avatar-changed': 'avatarChanged', 'audio-availability-changed': 'audioAvailabilityChanged', 'audio-mute-status-changed': 'audioMuteStatusChanged', 'camera-error': 'cameraError', 'device-list-changed': 'deviceListChanged', 'display-name-change': 'displayNameChange', 'email-change': 'emailChange', 'feedback-submitted': 'feedbackSubmitted', 'feedback-prompt-displayed': 'feedbackPromptDisplayed', 'filmstrip-display-changed': 'filmstripDisplayChanged', 'incoming-message': 'incomingMessage', 'mic-error': 'micError', 'outgoing-message': 'outgoingMessage', 'participant-joined': 'participantJoined', 'participant-kicked-out': 'participantKickedOut', 'participant-left': 'participantLeft', 'password-required': 'passwordRequired', 'proxy-connection-event': 'proxyConnectionEvent', 'video-ready-to-close': 'readyToClose', 'video-conference-joined': 'videoConferenceJoined', 'video-conference-left': 'videoConferenceLeft', 'video-availability-changed': 'videoAvailabilityChanged', 'video-mute-status-changed': 'videoMuteStatusChanged', 'screen-sharing-status-changed': 'screenSharingStatusChanged', 'dominant-speaker-changed': 'dominantSpeakerChanged', 'subject-change': 'subjectChange', 'suspend-detected': 'suspendDetected', 'tile-view-changed': 'tileViewChanged'}; let A = 0;
    ...
    function D(e, t) {
      ...
      }({}, t, {url: `${t.noSSL ? 'http' : 'https'}://${e}/#jitsi_meet_external_api_id=${A}`}));
    } function T(e) {
      let t;
      ...
      constructor(e, ...t) {
        super(); const {roomName: n = '', width: r = '100%', height: i = '100%', parentNode: s = document.body, configOverwrite: o = {}, interfaceConfigOverwrite: a = {}, noSSL: c = !1, jwt: u, onload: l, invitees: h, devices: d, userInfo: p} = function(e) {
          if (!e.length)
            return {}; switch (typeof e[0]) {
            case 'string':case void 0: { const [ t, n, r, i, s, o, a, c, u ] = e;

              return {roomName: t, width: n, height: r, parentNode: i, configOverwrite: s, interfaceConfigOverwrite: o, noSSL: a, jwt: c, onload: u}; } case 'object':return e[0]; default:throw new Error("Can't parse the arguments!");
          }
        }(t);

        this._parentNode = s, this._url = M(e, {configOverwrite: o, interfaceConfigOverwrite: a, jwt: u, noSSL: c, roomName: n, devices: d, userInfo: p}), this._createIFrame(i, r, l), this._transport = new x({backend: new _({postisOptions: {scope: `jitsi_meet_external_api_${A}`, window: this._frame.contentWindow}})}), Array.isArray(h) && h.length > 0 && this.invite(h), this._isLargeVideoVisible = !0, this._numberOfParticipants = 0, this._participants = {}, this._myUserID = void 0, this._onStageParticipant = void 0, this._setupListeners(), A++;
      }_createIFrame(e, t, n) {
        ...
        const e = this._frame.contentWindow; const t = e.document; let n = ''; const r = t.querySelector('base');
        ...
        const n = T(e); const r = T(t);

        void 0 !== n && (this._frame.style.height = n), void 0 !== r && (this._frame.style.width = r);
      }_setupListeners() {
        this._transport.on('event', e=>{
          let {name: t} = e; let n = I(e, ['name']); const r = n.id;

          switch (t) {
            case 'video-conference-joined':this._myUserID = r, this._participants[r] = {avatarURL: n.avatarURL}; case 'participant-joined':this._participants[r] = this._participants[r] || {}, this._participants[r].displayName = n.displayName, this._participants[r].formattedDisplayName = n.formattedDisplayName, D(this, 1); break; case 'participant-left':D(this, -1), delete this._participants[r]; break; case 'display-name-change': { const e = this._participants[r];

              e && (e.displayName = n.displayname, e.formattedDisplayName = n.formattedDisplayName); break; } case 'email-change': { const e = this._participants[r];

              e && (e.email = n.email); break; } case 'avatar-changed': { const e = this._participants[r];

              e && (e.avatarURL = n.avatarURL); break; } case 'on-stage-participant-changed':this._onStageParticipant = r, this.emit('largeVideoChanged'); break; case 'large-video-visibility-changed':this._isLargeVideoVisible = n.isVisible, this.emit('largeVideoChanged'); break; case 'video-conference-left':D(this, -1), delete this._participants[this._myUserID];
          } const i = N[t];
        ...
        e in P ? this._transport.sendEvent({data: t, name: P[e]}) : console.error('Not supported command name.');
      }executeCommands(e) {
        for (const t in e)
