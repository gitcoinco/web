...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
  'use strict'; _gsScope._gsDefine('TweenMax', [ 'core.Animation', 'core.SimpleTimeline', 'TweenLite' ], function(a, b, c) {
    var d = function(a) {
        ...
        e = function(a, b, c) {
          ...
          for (d in f)
            e = f[d], a[d] = 'function' == typeof e ? e(c, b[c]) : e[c % e.length]; delete a.cycle;
        },
        f = function(a, b, d) {
    ...
    f.version = '2.0.2', k.constructor = f, k.kill()._gc = !1, f.killTweensOf = f.killDelayedCallsTo = c.killTweensOf, f.getTweensOf = c.getTweensOf, f.lagSmoothing = c.lagSmoothing, f.ticker = c.ticker, f.render = c.render, k.invalidate = function() {
      ...
      b && this._startTime < this._timeline._time && (this._startTime = this._timeline._time, this._uncache(!1), this._gc ? this._enabled(!0, !1) : this._timeline.insert(this, this._startTime - this._delay)); for (d in a)
        this.vars[d] = a[d]; if (this._initted || f)
        if (b)
          this._initted = !1, f && this.render(0, !0, !0); else if (this._gc && this._enabled(!0, !1), this._notifyPluginsOfEnabled && this._firstPT && c._onPluginEvent('_onDisable', this), this._time / this._duration > .998) {
          var g = this._totalTime;

          this.render(0, !0, !1), this._initted = !1, this.render(g, !0, !1);
        } else if (this._initted = !1, this._init(), this._time > 0 || f)
          for (var h, i = 1 / (1 - e), j = this._firstPT; j;)
            h = j.s + j.c, j.c *= i, j.s = h - j.c, j = j._next; return this;
      ...
      if (a >= p - 1e-7 && a >= 0 ? (this._totalTime = p, this._cycle = this._repeat, this._yoyo && 0 !== (1 & this._cycle) ? (this._time = 0, this.ratio = this._ease._calcEnd ? this._ease.getRatio(0) : 0) : (this._time = t, this.ratio = this._ease._calcEnd ? this._ease.getRatio(1) : 1), this._reversed || (e = !0, f = 'onComplete', d = d || this._timeline.autoRemoveChildren), 0 === t && (this._initted || !this.vars.lazy || d) && (this._startTime === this._timeline._duration && (a = 0), (0 > u || 0 >= a && a >= -1e-7 || u === g && 'isPause' !== this.data) && u !== a && (d = !0, u > g && (f = 'onReverseComplete')), this._rawPrevTime = n = !b || a || u === a ? a : g)) : 1e-7 > a ? (this._totalTime = this._time = this._cycle = 0, this.ratio = this._ease._calcEnd ? this._ease.getRatio(0) : 0, (0 !== r || 0 === t && u > 0) && (f = 'onReverseComplete', e = this._reversed), 0 > a && (this._active = !1, 0 === t && (this._initted || !this.vars.lazy || d) && (u >= 0 && (d = !0), this._rawPrevTime = n = !b || a || u === a ? a : g)), this._initted || (d = !0)) : (this._totalTime = this._time = a, 0 !== this._repeat && (j = t + this._repeatDelay, this._cycle = this._totalTime / j >> 0, 0 !== this._cycle && this._cycle === this._totalTime / j && a >= r && this._cycle--, this._time = this._totalTime - this._cycle * j, this._yoyo && 0 !== (1 & this._cycle) && (this._time = t - this._time, o = this._yoyoEase || this.vars.yoyoEase, o && (this._yoyoEase || (o !== !0 || this._initted ? this._yoyoEase = o = o === !0 ? this._ease : o instanceof Ease ? o : Ease.map[o] : (o = this.vars.ease, this._yoyoEase = o = o ? o instanceof Ease ? o : 'function' == typeof o ? new Ease(o, this.vars.easeParams) : Ease.map[o] || c.defaultEase : c.defaultEase)), this.ratio = o ? 1 - o.getRatio((t - this._time) / t) : 0)), this._time > t ? this._time = t : this._time < 0 && (this._time = 0)), this._easeType && !o ? (k = this._time / t, l = this._easeType, m = this._easePower, (1 === l || 3 === l && k >= .5) && (k = 1 - k), 3 === l && (k *= 2), 1 === m ? k *= k : 2 === m ? k *= k * k : 3 === m ? k *= k * k * k : 4 === m && (k *= k * k * k * k), 1 === l ? this.ratio = 1 - k : 2 === l ? this.ratio = k : this._time / t < .5 ? this.ratio = k / 2 : this.ratio = 1 - k / 2) : o || (this.ratio = this._ease.getRatio(this._time / t))), q === this._time && !d && s === this._cycle)
        return void (r !== this._totalTime && this._onUpdate && (b || this._callback('onUpdate'))); if (!this._initted) {
      ...
      for (j(a) || ('string' == typeof a && (a = c.selector(a) || a), i(a) && (a = d(a))), a = a || [], 0 > h && (a = d(a), a.reverse(), h *= -1), o = a.length - 1, q = 0; o >= q; q++) {
        p = {}; for (r in g)
          p[r] = g[r]; if (v && (e(p, a, q), null != p.duration && (b = p.duration, delete p.duration)), w) {
          w = p.startAt = {}; for (r in g.startAt)
            w[r] = g.startAt[r]; e(p.startAt, a, q);
      ...
      return c.getTweensOf(a, !0).length > 0;
          ...
          for (var d = [], e = 0, f = a._first; f;)
            f instanceof c ? d[e++] = f : (b && (d[e++] = f), d = d.concat(m(f, b)), e = d.length), f = f._next; return d;
        },
    ...
    f.killAll = function(a, c, d, e) {
      ...
      if (null != a) {
        ...
        if ('string' == typeof a && (a = c.selector(a) || a), i(a) && (a = d(a)), j(a))
          for (l = a.length; --l > -1;)
            f.killChildTweensOf(a[l], b); else {
          e = []; for (k in n)
    ...
    var d = function(a) {
          ...
          for (d in e)
            c = e[d], i(c) && -1 !== c.join('').indexOf('{self}') && (e[d] = this._swapSelfInParams(c)); i(e.tweens) && this.add(e.tweens, 0, e.align, e.stagger);
        },
        e = 1e-10,
        f = c._internals,
        g = d._internals = {},
    ...
    return d.version = '2.0.2', q.constructor = d, q.kill()._gc = q._forcingPlayhead = q._hasPause = !1, q.to = function(a, b, d, e) {
      ...
      for ('string' == typeof a && (a = c.selector(a) || a), a = a || [], h(a) && (a = p(a)), f = f || 0, 0 > f && (a = p(a), a.reverse(), f *= -1), o = 0; o < a.length; o++)
        l = m(e), l.startAt && (l.startAt = m(l.startAt), l.startAt.cycle && n(l.startAt, a, o)), r && (n(l, a, o), null != l.duration && (b = l.duration, delete l.duration)), q.to(a[o], b, l, o * f); return this.add(q, g);
      ...
      for (null == b && (b = !0), j._remove(i, !0), i._startTime = 0, i._rawPrevTime = i._time = i._totalTime = j._time, g = j._first; g;)
        h = g._next, b && g instanceof c && g.target === g.vars.onComplete || (f = g._startTime - g._delay, 0 > f && (e = 1), i.add(g, f)), g = h; return j.add(i, 0), e && i.totalDuration(), i;
      ...
      if ('number' != typeof f && (f = this._parseTimeOrLabel(f, 0, !0, e)), !(e instanceof a)) {
        ...
        for (n = this, o = n.rawTime() > e._startTime; n._timeline;)
          o && n._timeline.smoothChildTiming ? n.totalTime(n._totalTime, !0) : n._gc && n._enabled(!0, !1), n = n._timeline; return this;
    }, q.remove = function(b) {
      if (b instanceof a) {
        this._remove(b, !1); var c = b._timeline = b.vars.useFrames ? a._rootFramesTimeline : a._rootTimeline;
      ...
      b.prototype._remove.call(this, a, c); var d = this._last;
      ...
      if (n !== this._time && (a += this._time - n), a >= o - 1e-7 && a >= 0)
        this._totalTime = this._time = o, this._reversed || this._hasPausedChild() || (f = !0, h = 'onComplete', i = !!this._timeline.autoRemoveChildren, 0 === this._duration && (0 >= a && a >= -1e-7 || this._rawPrevTime < 0 || this._rawPrevTime === e) && this._rawPrevTime !== a && this._first && (i = !0, this._rawPrevTime > e && (h = 'onReverseComplete'))), this._rawPrevTime = this._duration || !b || a || this._rawPrevTime === a ? a : e, a = o + 1e-4; else if (1e-7 > a)
        if (this._totalTime = this._time = 0, (0 !== n || 0 === this._duration && this._rawPrevTime !== e && (this._rawPrevTime > 0 || 0 > a && this._rawPrevTime >= 0)) && (h = 'onReverseComplete', f = this._reversed), 0 > a)
          this._active = !1, this._timeline.autoRemoveChildren && this._reversed ? (i = f = !0, h = 'onReverseComplete') : this._rawPrevTime >= 0 && this._first && (i = !0), this._rawPrevTime = a; else {
        ...
        if (this._initted || (this._initted = !0), this._active || !this._paused && this._time !== n && a > 0 && (this._active = !0), 0 === n && this.vars.onStart && (0 === this._time && this._duration || b || this._callback('onStart')), m = this._time, m >= n)
          for (d = this._first; d && (g = d._next, m === this._time && (!this._paused || r));)
            (d._active || d._startTime <= m && !d._paused && !d._gc) && (l === d && this.pause(), d._reversed ? d.render((d._dirty ? d.totalDuration() : d._totalDuration) - (a - d._startTime) * d._timeScale, b, c) : d.render((a - d._startTime) * d._timeScale, b, c)), d = g; else
      ...
      e = e || -9999999999; for (var f = [], g = this._first, h = 0; g;)
        g._startTime < e || (g instanceof c ? b !== !1 && (f[h++] = g) : (d !== !1 && (f[h++] = g), a !== !1 && (f = f.concat(g.getChildren(!0, b, d)), h = f.length))), g = g._next; return f;
      ...
      for (f && this._enabled(!0, !0), d = c.getTweensOf(a), e = d.length; --e > -1;)
        (d[e].timeline === this || b && this._contains(d[e])) && (g[h++] = d[e]); return f && this._enabled(!1, !0), g;
    }, q.recent = function() {
      return this._recent;
    }, q._contains = function(a) {
      for (var b = a.timeline; b;) {
        if (b === this)
          return !0; b = b.timeline;
      } return !1;
    }, q.shiftChildren = function(a, b, c) {
      c = c || 0; for (var d, e = this._first, f = this._labels; e;)
        e._startTime >= c && (e._startTime += a), e = e._next; if (b)
        for (d in f)
          f[d] >= c && (f[d] += a); return this._uncache(!0);
    }, q._kill = function(a, b) {
      if (!a && !b)
        return this._enabled(!1, !1); for (var c = b ? this.getTweensOf(b) : this.getChildren(!0, !0, !1), d = c.length, e = !1; --d > -1;)
        c[d]._kill(a, b) && (e = !0); return e;
    }, q.clear = function(a) {
      var b = this.getChildren(!1, !0, !0),
          c = b.length;

      for (this._time = this._totalTime = 0; --c > -1;)
        b[c]._enabled(!1, !1); return a !== !1 && (this._labels = {}), this._uncache(!0);
    }, q.invalidate = function() {
      for (var b = this._first; b;)
        b.invalidate(), b = b._next; return a.prototype.invalidate.call(this);
    }, q._enabled = function(a, c) {
      if (a === this._gc)
        for (var d = this._first; d;)
          d._enabled(a, !0), d = d._next; return b.prototype._enabled.call(this, a, c);
    }, q.totalTime = function(b, c, d) {
      this._forcingPlayhead = !0; var e = a.prototype.totalTime.apply(this, arguments);
      ...
      if (!b)
        for (var c = this._first, d = this._time; c;)
          c._startTime === d && 'isPause' === c.data && (c._rawPrevTime = 0), c = c._next; return a.prototype.paused.apply(this, arguments);
    }, q.usesFrames = function() {
      for (var b = this._timeline; b._timeline;)
        b = b._timeline; return b === a._rootFramesTimeline;
    ...
    return k.constructor = d, k.kill()._gc = !1, d.version = '2.0.2', k.invalidate = function() {
      ...
      if (a)
        if (null == b)
          this._kill(null, a); else
          for (var c = this.getTweensOf(a, !1), d = c.length, e = this._parseTimeOrLabel(b); --d > -1;)
            c[d]._startTime === e && c[d]._enabled(!1, !1); return this;
      ...
      for (e in c)
        g[e] = c[e]; return g.time = this._parseTimeOrLabel(a), d = Math.abs(Number(g.time) - this._time) / this._timeScale || .001, f = new h(this, d, g), g.onStart = function() {
        f.target.paused(!0), f.vars.time === f.target.time() || d !== f.duration() || f.isFromTo || f.duration(Math.abs(f.vars.time - f.target.time()) / f.target._timeScale).render(f.time(), !0, !0), c.onStart && c.onStart.apply(c.onStartScope || c.callbackScope || f, c.onStartParams || []);
      }, f;
    }, k.tweenFromTo = function(a, b, c) {
      c = c || {}, a = this._parseTimeOrLabel(a), c.startAt = {onComplete: this.seek, onCompleteParams: [a], callbackScope: this}, c.immediateRender = c.immediateRender !== !1; var d = this.tweenTo(b, c);
      ...
      if (o !== this._time && (a += this._time - o), a >= p - 1e-7 && a >= 0)
        ...
        if (this._locked || (this._totalTime = this._cycle = 0), this._time = 0, (0 !== o || 0 === q && u !== e && (u > 0 || 0 > a && u >= 0) && !this._locked) && (j = 'onReverseComplete', f = this._reversed), 0 > a)
          this._active = !1, this._timeline.autoRemoveChildren && this._reversed ? (k = f = !0, j = 'onReverseComplete') : u >= 0 && this._first && (k = !0), this._rawPrevTime = a; else {
        ...
        for (d = this._first; d && (i = d._next, n === this._time && (!this._paused || v));)
          (d._active || d._startTime <= this._time && !d._paused && !d._gc) && (m === d && this.pause(), d._reversed ? d.render((d._dirty ? d.totalDuration() : d._totalDuration) - (a - d._startTime) * d._timeScale, b, c) : d.render((a - d._startTime) * d._timeScale, b, c)), d = i; else
      ...
      for (d = 0; i > d; d++)
        e = g[d], e.isActive() && (f[h++] = e); return f;
    ...
    var a = 180 / Math.PI,
        ...
        j = function(a, e, f, g, h) {
          ...
          for (j = 0; w > j; j++)
            n = a[x], k = n.a, l = n.d, m = a[x + 1].d, h ? (t = b[j], u = c[j], v = (u + t) * e * .25 / (g ? .5 : d[j] || .5), o = l - (l - k) * (g ? .5 * e : 0 !== t ? v / t : 0), p = l + (m - l) * (g ? .5 * e : 0 !== u ? v / u : 0), q = l - (o + ((p - o) * (3 * t / (t + u) + .5) / 4 || 0))) : (o = l - (l - k) * e * .5, p = l + (m - l) * e * .5, q = l - (o + p) / 2), o += q, p += q, n.c = r = o, 0 !== j ? n.b = y : n.b = y = n.a + .6 * (n.c - n.a), n.da = l - k, n.ca = r - k, n.ba = y - k, f ? (s = i(k, y, r, l), a.splice(x, 1, s[0], s[1], s[2], s[3]), x += 4) : x++, y = p; n = a[x], n.b = y, n.c = y + .4 * (n.d - y), n.da = n.d - n.a, n.ca = n.c - n.a, n.ba = y - n.a, f && (s = i(n.a, y, n.c, n.d), a.splice(x, 1, s[0], s[1], s[2], s[3]));
        },
        k = function(a, d, e, f) {
          var h,
              i,
          ...
          if (f)
            ...
            return n[0] = new g(a[0][d], 0, 0, a[0][d]), n; for (i = 0; h > i; i++)
            j = a[i][d], k = a[i + 1][d], n[i] = new g(j, 0, 0, k), e && (l = a[i + 2][d], b[i] = (b[i] || 0) + (k - j) * (k - j), c[i] = (c[i] || 0) + (l - k) * (l - k)); return n[i] = new g(a[i][d], 0, 0, a[i + 1][d]), n;
        },
        l = function(a, f, g, i, l, m) {
          ...
          l = 'string' == typeof l ? ',' + l + ',' : h, null == f && (f = 1); for (o in a[0])
            w.push(o); if (a.length > 1) {
            ...
            b[n] = Math.sqrt(b[n]),
            c[n] = Math.sqrt(c[n]); if (!i) {
            for (n = w.length; --n > -1;)
              if (e[o])
                for (p = v[w[n]], s = p.length - 1, q = 0; s > q; q++)
                  r = p[q + 1].da / c[q] + p[q].da / b[q] || 0, d[q] = (d[q] || 0) + r * r; for (n = d.length; --n > -1;)
              d[n] = Math.sqrt(d[n]);
          } for (n = w.length, q = g ? 4 : 1; --n > -1;)
            o = w[n], p = v[o], j(p, f, g, i, e[o]), t && (p.splice(0, q), p.splice(p.length - q, q)); return v;
        },
        m = function(a, b, c) {
          b = b || 'soft'; var d,
              e,
          ...
          if (r && c && (a = [c].concat(a)), null == a || a.length < q + 1)
            throw 'invalid Bezier data'; for (m in a[0])
            s.push(m); for (j = s.length; --j > -1;) {
        ...
        o = function(a, b) {
          ...
          for (c in a)
            n(a[c], g, b); for (e = g.length, d = 0; e > d; d++)
            i += Math.sqrt(g[d]), f = d % b, m[f] = i, f === k && (j += i, f = d / b >> 0, l[f] = m, h[f] = j, i = 0, m = []); return {length: j, lengths: h, segments: l};
        },
        p = _gsScope._gsDefine.plugin({propName: 'bezier', priority: -1, version: '1.3.8', API: 2, global: !0, init: function(a, b, c) {
          ...
          if (this._timeRes) {
            ...
            f = this._props[e], g = this._beziers[f][c], i = (h * h * g.da + 3 * d * (h * g.ca + d * g.ba)) * h + g.a, this._mod[f] && (i = this._mod[f](i, o)), n[f] ? o[f](i) : o[f] = i; if (this._autoRotate) {
            var q,
                r,
                s,
                t,
    ...
    p.bezierThrough = l, p.cubicToQuadratic = i, p._autoCSS = !0, p.quadraticToCubic = function(a, b, c) {
      ...
      if (a) {
        ...
        b._registerComplexSpecialProp('bezier', {parser: function(a, b, f, g, h, i) {
          ...
          if (0 > n)
            return h; for (j = 0; n >= j; j++)
            l = c(a, m[j], g, h, i, n !== j), o[j] = l.end; for (k in b)
            q[k] = b[k]; return q.values = o, h = new e(a, 'bezier', 0, 0, l.pt, 2), h.data = l, h.plugin = i, h.setRatio = d, 0 === q.autoRotate && (q.autoRotate = !0), !q.autoRotate || q.autoRotate instanceof Array || (j = q.autoRotate === !0 ? 0 : Number(q.autoRotate), q.autoRotate = null != l.end.left ? [[ 'left', 'top', 'rotation', j, !1 ]] : null != l.end.x ? [[ 'x', 'y', 'rotation', j, !1 ]] : !1), q.autoRotate && (g._transform || g._enableTransforms(!1), l.autoRotate = g._target._gsTransform, l.proxy.rotation = l.autoRotate.rotation || 0, g._overwriteProps.push('rotation')), i._onInitTween(l.proxy, q, g._tween), h;
        }});
      }
    }, q._mod = function(a) {
      ...
      for (b in this._beziers)
        ...
        for (c = d.length; --c > -1;)
          a[d[c][2]] && d.splice(c, 1); return this._super._kill.call(this, a);
    };
    ...
    j.constructor = g, g.version = '2.0.2', g.API = 2, g.defaultTransformPerspective = 0, g.defaultSkewType = 'compensated', g.defaultSmoothOrigin = !0, j = 'px', g.suffixMap = {top: j, right: j, bottom: j, left: j, width: j, height: j, fontSize: j, padding: j, margin: j, perspective: j, lineHeight: ''}; var k,
        l,
        m,
        n,
        o,
        ...
        Z = function(a, b) {
          ...
          if (void 0 !== e[a])
            return a; for (a = a.charAt(0).toUpperCase() + a.substr(1), c = [ 'O', 'Moz', 'ms', 'Ms', 'Webkit' ], d = 5; --d > -1 && void 0 === e[c[d] + a];)
        ...
        aa = S.convertToPixels = function(a, c, d, e, f) {
          ...
          if (n && (d = -d), o && (d *= 100), 'lineHeight' !== c || e)
            if ('%' === e && -1 !== c.indexOf('border'))
              h = d / 100 * (k ? a.clientWidth : a.clientHeight); else {
              if (m.cssText = 'border:0 solid red;position:' + _(a, 'position') + ';line-height:0;', '%' !== e && l.appendChild && 'v' !== e.charAt(0) && 'rem' !== e)
                m[k ? 'borderLeftWidth' : 'borderTopWidth'] = d + e; else {
                if (l = a.parentNode || O.body, -1 !== _(l, 'display').indexOf('flex') && (m.position = 'absolute'), i = l._gsCache, j = b.ticker.frame, i && k && i.time === j)
                  return i.width * d / 100; m[k ? 'width' : 'height'] = d + e;
              }l.appendChild(Q), h = parseFloat(Q[k ? 'offsetWidth' : 'offsetHeight']), l.removeChild(Q), k && '%' === e && g.cacheWidths !== !1 && (i = l._gsCache = l._gsCache || {}, i.time = j, i.width = h / d * 100), 0 !== h || f || (h = aa(a, c, d, e, !0));
            } else
            i = $(a).lineHeight, a.style.lineHeight = d, h = parseFloat($(a).lineHeight), a.style.lineHeight = i; return o && (h /= 100), n ? -h : h;
        },
        ba = S.calculateOffset = function(a, b, c) {
          if ('absolute' !== _(a, 'position', c))
            return 0; var d = 'left' === b ? 'Left' : 'Top',
              e = _(a, 'margin' + d, c);
        ...
        ca = function(a, b) {
          ...
          if (b = b || $(a, null))
            if (c = b.length)
              for (;--c > -1;)
                e = b[c], (-1 === e.indexOf('-transform') || Da === e) && (f[e.replace(C, E)] = b.getPropertyValue(e)); else
              for (c in b)
                (-1 === c.indexOf('Transform') || Ca === c) && (f[c] = b[c]); else if (b = a.currentStyle || a.style)
            for (c in b)
              'string' == typeof c && void 0 === f[c] && (f[c.replace(C, E)] = b[c]); return U || (f.opacity = V(a)), d = Ra(a, b, !1), f.rotation = d.rotation, f.skewX = d.skewX, f.scaleX = d.scaleX, f.scaleY = d.scaleY, f.x = d.x, f.y = d.y, Fa && (f.z = d.z, f.rotationX = d.rotationX, f.rotationY = d.rotationY, f.scaleZ = d.scaleZ), f.filters && delete f.filters, f;
        },
        da = function(a, b, c, d, e) {
          ...
          for (g in c)
            ...
            for (g in d)
              'className' !== g && (i[g] = d[g]); return {difs: i, firstMPT: h};
        },
        ea = {width: [ 'Left', 'Right' ], height: [ 'Top', 'Bottom' ]},
        fa = [ 'marginLeft', 'marginRight', 'marginTop', 'marginBottom' ],
        ga = function(a, b, c) {
          if ('svg' === (a.nodeName + '').toLowerCase())
            return (c || $(a))[b] || 0; if (a.getCTM && Oa(a))
            return a.getBBox()[b] || 0; var d = parseFloat('width' === b ? a.offsetWidth : a.offsetHeight),
              e = ea[b],
              f = e.length;

          for (c = c || $(a, null); --f > -1;)
            d -= parseFloat(_(a, 'padding' + e[f], c, !0)) || 0, d -= parseFloat(_(a, 'border' + e[f] + 'Width', c, !0)) || 0; return d;
        },
        ha = function(a, b) {
          if ('contain' === a || 'auto' === a || 'auto auto' === a)
            return a + ' '; (null == a || '' === a) && (a = '0 0'); var c,
              d = a.split(' '),
        ...
        ja = function(a, b) {
          'function' == typeof a && (a = a(r, q)); var c = 'string' == typeof a && '=' === a.charAt(1);
            ...
            if ('number' == typeof a)
              ...
              if (',' === a.charAt(a.length - 1) && (a = a.substr(0, a.length - 1)), la[a])
                ...
                if (c = m = a.match(s), b) {
                  ...
                  g = Number(c[0]) % 360 / 360, h = Number(c[1]) / 100, i = Number(c[2]) / 100, e = .5 >= i ? i * (h + 1) : i + h - i * h, d = 2 * i - e, c.length > 3 && (c[3] = Number(c[3])), c[0] = ma(g + 1 / 3, d, e), c[1] = ma(g, d, e), c[2] = ma(g - 1 / 3, d, e); else
                c = a.match(s) || la.transparent; c[0] = Number(c[0]), c[1] = Number(c[1]), c[2] = Number(c[2]), c.length > 3 && (c[3] = Number(c[3]));
            } else
            c = la.black; return b && !m && (d = c[0] / 255, e = c[1] / 255, f = c[2] / 255, j = Math.max(d, e, f), k = Math.min(d, e, f), i = (j + k) / 2, j === k ? g = h = 0 : (l = j - k, h = i > .5 ? l / (2 - j - k) : l / (j + k), g = j === d ? (e - f) / l + (f > e ? 6 : 0) : j === e ? (f - d) / l + 2 : (d - e) / l + 4, g *= 60), c[0] = g + .5 | 0, c[1] = 100 * h + .5 | 0, c[2] = 100 * i + .5 | 0), c;
        },
        oa = function(a, b) {
          var c,
              d,
          ...
          if (!f.length)
            return a; for (c = 0; c < f.length; c++)
            d = f[c], e = a.substr(g, a.indexOf(d, g) - g), g += e.length + d.length, d = na(d, b), 3 === d.length && d.push(1), h += e + (b ? 'hsla(' + d[0] + ',' + d[1] + '%,' + d[2] + '%,' + d[3] : 'rgba(' + d.join(',')) + ')'; return h + a.substr(g);
        },
        pa = '(?:\\b(?:(?:rgb|rgba|hsl|hsla)\\(.+?\\))|\\B#(?:[0-9a-f]{3}){1,2}\\b';

    for (j in la)
      pa += '|' + j + '\\b'; pa = new RegExp(pa + ')', 'gi'), g.colorStringFilter = function(a) {
      var b,
          c = a[0] + ' ' + a[1];

      pa.test(c) && (b = -1 !== c.indexOf('hsl(') || -1 !== c.indexOf('hsla('), a[0] = oa(a[0], b), a[1] = oa(a[1], b)), pa.lastIndex = 0;
    }, b.defaultStringFilter || (b.defaultStringFilter = g.colorStringFilter); var qa = function(a, b, c, d) {
          if (null == a)
            return function(a) {
              return a;
            }; var e,
          ...
          return k ? e = b ? function(a) {
            ...
            if ('number' == typeof a)
              a += l; else if (d && I.test(a)) {
              for (o = a.replace(I, '|').split('|'), n = 0; n < o.length; n++)
                o[n] = e(o[n]); return o.join(',');
            } if (b = (a.match(pa) || [f])[0], m = a.split(b).join('').match(u) || [], n = m.length, k > n--)
              for (;++n < k;)
                m[n] = c ? m[(n - 1) / 2 | 0] : g[n]; return h + m.join(j) + j + b + i + (-1 !== a.indexOf('inset') ? ' inset' : '');
          } : function(a) {
            var b,
                f,
                m;
            ...
            if ('number' == typeof a)
              ...
              for (;++m < k;)
                b[m] = c ? b[(m - 1) / 2 | 0] : g[m]; return h + b.join(j) + i;
          } : function(a) {
            return a;
          };
        },
        ra = function(a) {
          return a = a.split(','), function(b, c, d, e, f, g, h) {
            ...
            for (h = {}, i = 0; 4 > i; i++)
              h[a[i]] = j[i] = j[i] || j[(i - 1) / 2 >> 0]; return e.parse(b, h, f, g);
          };
        },
        sa = (S._setPluginRatio = function(a) {
          this.plugin.setRatio(a); for (var b, c, d, e, f, g = this.data, h = g.proxy, i = g.firstMPT, j = 1e-6; i;)
            b = h[i.v], i.r ? b = i.r(b) : j > b && b > -j && (b = 0), i.t[i.p] = b, i = i._next; if (g.autoRotate && (g.autoRotate.rotation = g.mod ? g.mod.call(this._tween, h.rotation, this.t, this._tween) : h.rotation), 1 === a || 0 === a)
            for (i = g.firstMPT, f = 1 === a ? 'e' : 'b'; i;) {
              if (c = i.t, c.type) {
                if (1 === c.type) {
                  for (e = c.xs0 + c.s + c.xs1, d = 1; d < c.l; d++)
                    e += c['xn' + d] + c['xs' + (d + 1)]; c[f] = e;
                }
              } else
                c[f] = c.s + c.xs0; i = i._next;
            }
        }, function(a, b, c, d, e) {
        ...
        ta = (S._parseToProxy = function(a, b, c, d, e, f) {
          ...
          for (c._transform = null, M = b, d = k = c.parse(a, b, d, e), M = p, f && (c._transform = o, l && (l._prev = null, l._prev && (l._prev._next = null))); d && d !== l;) {
            if (d.type <= 1 && (h = d.p, n[h] = d.s + d.c, m[h] = d.s, f || (j = new sa(d, 's', h, j, d.r), d.c = 0), 1 === d.type))
              for (g = d.l; --g > 0;)
                i = 'xn' + g, h = d.p + '_' + i, n[h] = d.data[i], m[h] = d[i], f || (j = new sa(d, i, h, j, d.rxp[i])); d = d._next;
        ...
        va = g.parseComplex = function(a, b, c, d, e, f, h, i, j, l) {
          ...
          for ((-1 !== d.indexOf(',') || -1 !== c.indexOf(',')) && (-1 !== (d + c).indexOf('rgb') || -1 !== (d + c).indexOf('hsl') ? (D = D.join(' ').replace(I, ', ').split(' '), E = E.join(' ').replace(I, ', ').split(' ')) : (D = D.join(' ').split(',').join(', ').split(' '), E = E.join(' ').split(',').join(', ').split(' ')), F = D.length), F !== E.length && (D = (f || '').split(' '), F = D.length), h.plugin = j, h.setRatio = l, pa.lastIndex = 0, m = 0; F > m; m++)
            if (p = D[m], u = E[m] + '', x = parseFloat(p), x || 0 === x)
              h.appendXtra('', x, ia(u, x), u.replace(t, ''), G && -1 !== u.indexOf('px') ? Math.round : !1, !0); else if (e && pa.test(p))
              B = u.indexOf(')') + 1, B = ')' + (B ? u.substr(B) : ''), C = -1 !== u.indexOf('hsl') && U, z = u, p = na(p, C), u = na(u, C), y = p.length + u.length > 6, y && !U && 0 === u[3] ? (h['xs' + h.l] += h.l ? ' transparent' : 'transparent', h.e = h.e.split(E[m]).join('transparent')) : (U || (y = !1), C ? h.appendXtra(z.substr(0, z.indexOf('hsl')) + (y ? 'hsla(' : 'hsl('), p[0], ia(u[0], p[0]), ',', !1, !0).appendXtra('', p[1], ia(u[1], p[1]), '%,', !1).appendXtra('', p[2], ia(u[2], p[2]), y ? '%,' : '%' + B, !1) : h.appendXtra(z.substr(0, z.indexOf('rgb')) + (y ? 'rgba(' : 'rgb('), p[0], u[0] - p[0], ',', Math.round, !0).appendXtra('', p[1], u[1] - p[1], ',', Math.round).appendXtra('', p[2], u[2] - p[2], y ? ',' : B, Math.round), y && (p = p.length < 4 ? 1 : p[3], h.appendXtra('', p, (u.length < 4 ? 1 : u[3]) - p, B, !1))), pa.lastIndex = 0; else if (v = p.match(s)) {
              if (w = u.match(t), !w || w.length !== v.length)
                return h; for (o = 0, n = 0; n < v.length; n++)
                A = v[n], z = p.indexOf(A, o), h.appendXtra(p.substr(o, z - o), Number(A), ia(w[n], A), '', G && 'px' === p.substr(z + A.length, 2) ? Math.round : !1, 0 === n), o = z + A.length; h['xs' + h.l] += p.substr(o);
            } else
              h['xs' + h.l] += h.l || h['xs' + h.l] ? ' ' + u : u; if (-1 !== d.indexOf('=') && h.data) {
    ...
    for (j = ta.prototype, j.l = j.pr = 0; --wa > 0;)
      j['xn' + wa] = 0, j['xs' + wa] = ''; j.xs0 = '', j._next = j._prev = j.xfirst = j.data = j.plugin = j.setRatio = j.rxp = null, j.appendXtra = function(a, b, c, d, e, f) {
      var g = this,
          h = g.l;
    ...
    j = xa.prototype, j.parseComplex = function(a, b, c, d, e, f) {
      ...
      ya(a, {parser: function(a, d, e, f, g, h, i) {
        ...
        Ia = function(a, b, c) {
          ...
          for (d in c)
            e.setAttributeNS(null, d.replace(f, '$1-$2').toLowerCase(), c[d]); return b.appendChild(e), e;
        },
        ...
        Ma = function(a) {
          ...
          if (Ja.appendChild(c), c.appendChild(this), this.style.display = 'block', a)
            ...
            this._originalGetBBox && (b = this._originalGetBBox()); return e ? d.insertBefore(this, e) : d.appendChild(this), Ja.removeChild(c), this.style.cssText = f, b;
        },
        Na = function(a) {
          try {
            return a.getBBox();
        ...
        Qa = function(a, b) {
          ...
          if (Ca ? d = _(a, Da, null, !0) : a.currentStyle && (d = a.currentStyle.filter.match(G), d = d && 4 === d.length ? [ d[0].substr(4), Number(d[2].substr(4)), Number(d[1].substr(4)), d[3].substr(4), i.x || 0, i.y || 0 ].join(',') : ''), c = !d || 'none' === d || 'matrix(1, 0, 0, 1, 0, 0)' === d, !Ca || !(h = !$(a) || 'none' === $(a).display) && a.parentNode || (h && (f = k.display, k.display = 'block'), a.parentNode || (g = 1, Ja.appendChild(a)), d = _(a, Da, null, !0), c = !d || 'none' === d || 'matrix(1, 0, 0, 1, 0, 0)' === d, f ? k.display = f : h && Va(k, 'display'), g && Ja.removeChild(a)), (i.svg || a.getCTM && Oa(a)) && (c && -1 !== (k[Ca] + '').indexOf('matrix') && (d = k[Ca], c = 0), e = a.getAttribute('transform'), c && e && (e = a.transform.baseVal.consolidate().matrix, d = 'matrix(' + e.a + ',' + e.b + ',' + e.c + ',' + e.d + ',' + e.e + ',' + e.f + ')', c = 0)), c)
            return Pa; for (e = (d || '').match(s) || [], wa = e.length; --wa > -1;)
            f = Number(e[wa]), e[wa] = (g = f - (f |= 0)) ? (g * j + (0 > g ? -.5 : .5) | 0) / j + f : f; return b && e.length > 6 ? [ e[0], e[1], e[4], e[5], e[12], e[13] ] : e;
        },
        Ra = S.getTransform = function(a, c, d, e) {
          if (a._gsTransform && d && !e)
            return a._gsTransform; var f,
              h,
              i,
              j,
              k,
        ...
        Ta = S.set3DTransformRatio = S.setTransformRatio = function(a) {
          ...
          if (O && (P += O, B += O), ((1 === a || 0 === a) && 'auto' === N && (this.tween._totalTime === this.tween._totalDuration || !this.tween._totalTime) || !N) && !J && !M && !D && !C && 1 === G || Aa && L || !Fa)
            return void (B || P || L ? (B *= K, x = P * K, y = 1e5, c = Math.cos(B) * E, f = Math.sin(B) * E, d = Math.sin(B - x) * -F, g = Math.cos(B - x) * F, x && 'simple' === z.skewType && (b = Math.tan(x - O * K), b = Math.sqrt(1 + b * b), d *= b, g *= b, O && (b = Math.tan(O * K), b = Math.sqrt(1 + b * b), c *= b, f *= b)), L && (H += z.xOrigin - (z.xOrigin * c + z.yOrigin * d) + z.xOffset, I += z.yOrigin - (z.xOrigin * f + z.yOrigin * g) + z.yOffset, Aa && (z.xPercent || z.yPercent) && (q = this.t.getBBox(), H += .01 * z.xPercent * q.width, I += .01 * z.yPercent * q.height), q = 1e-6, q > H && H > -q && (H = 0), q > I && I > -q && (I = 0)), u = (c * y | 0) / y + ',' + (f * y | 0) / y + ',' + (d * y | 0) / y + ',' + (g * y | 0) / y + ',' + H + ',' + I + ')', L && Aa ? this.t.setAttribute('transform', 'matrix(' + u) : A[Ca] = (z.xPercent || z.yPercent ? 'translate(' + z.xPercent + '%,' + z.yPercent + '%) matrix(' : 'matrix(') + u) : A[Ca] = (z.xPercent || z.yPercent ? 'translate(' + z.xPercent + '%,' + z.yPercent + '%) matrix(' : 'matrix(') + E + ',0,0,' + F + ',' + H + ',' + I + ')'); if (n && (q = 1e-4, q > E && E > -q && (E = G = 2e-5), q > F && F > -q && (F = G = 2e-5), !M || z.z || z.rotationX || z.rotationY || (M = 0)), B || P)
            B *= K, r = c = Math.cos(B), s = f = Math.sin(B), P && (B -= P * K, r = Math.cos(B), s = Math.sin(B), 'simple' === z.skewType && (b = Math.tan((P - O) * K), b = Math.sqrt(1 + b * b), r *= b, s *= b, z.skewY && (b = Math.tan(O * K), b = Math.sqrt(1 + b * b), c *= b, f *= b))), d = -s, g = r; else {
            if (!(D || C || 1 !== G || M || L))
              return void (A[Ca] = (z.xPercent || z.yPercent ? 'translate(' + z.xPercent + '%,' + z.yPercent + '%) translate3d(' : 'translate3d(') + H + 'px,' + I + 'px,' + J + 'px)' + (1 !== E || 1 !== F ? ' scale(' + E + ',' + F + ')' : '')); c = g = 1, d = f = 0;
    ...
    j = Ga.prototype, j.x = j.y = j.z = j.skewX = j.skewY = j.rotation = j.rotationX = j.rotationY = j.zOrigin = j.xPercent = j.yPercent = j.xOffset = j.yOffset = 0, j.scaleX = j.scaleY = j.scaleZ = 1, ya('transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin', {parser: function(a, b, c, d, f, h, i) {
      if (d._lastParsedTransform === i)
        return f; d._lastParsedTransform = i; var j,
          k = i.scale && 'function' == typeof i.scale ? i.scale : 0;

      'function' == typeof i[c] && (j = i[c], i[c] = b), k && (i.scale = k(r, a)); var l,
          m,
          n,
          o,
          p,
      ...
      if (D.skewType = A.skewType || D.skewType || g.defaultSkewType, d._transform = D, 'rotationZ' in A && (A.rotation = A.rotationZ), E && 'string' == typeof E && Ca)
        ...
        if (l = {scaleX: ja(null != A.scaleX ? A.scaleX : A.scale, D.scaleX), scaleY: ja(null != A.scaleY ? A.scaleY : A.scale, D.scaleY), scaleZ: ja(A.scaleZ, D.scaleZ), x: ja(A.x, D.x), y: ja(A.y, D.y), z: ja(A.z, D.z), xPercent: ja(A.xPercent, D.xPercent), yPercent: ja(A.yPercent, D.yPercent), perspective: ja(A.transformPerspective, D.perspective)}, p = A.directionalRotation, null != p)
          if ('object' == typeof p)
            for (m in p)
              A[m] = p[m]; else
            A.rotation = p; 'string' == typeof A.x && -1 !== A.x.indexOf('%') && (l.x = 0, l.xPercent = ja(A.x, D.xPercent)), 'string' == typeof A.y && -1 !== A.y.indexOf('%') && (l.y = 0, l.yPercent = ja(A.y, D.yPercent)), l.rotation = ka('rotation' in A ? A.rotation : 'shortRotation' in A ? A.shortRotation + '_short' : D.rotation, D.rotation, 'rotation', B), Fa && (l.rotationX = ka('rotationX' in A ? A.rotationX : 'shortRotationX' in A ? A.shortRotationX + '_short' : D.rotationX || 0, D.rotationX, 'rotationX', B), l.rotationY = ka('rotationY' in A ? A.rotationY : 'shortRotationY' in A ? A.shortRotationY + '_short' : D.rotationY || 0, D.rotationY, 'rotationY', B)), l.skewX = ka(A.skewX, D.skewX), l.skewY = ka(A.skewY, D.skewY);
        ...
        v = Ba[z], E = l[v] - D[v], (E > y || -y > E || null != A[v] || null != M[v]) && (o = !0, f = new ta(D, v, D[v], E, f), v in B && (f.e = B[v]), f.xs0 = 0, f.plugin = h, d._overwriteProps.push(f.n)); return E = A.transformOrigin, D.svg && (E || A.svgOrigin) && (s = D.xOffset, t = D.yOffset, La(a, ha(E), l, A.svgOrigin, A.smoothOrigin), f = ua(D, 'xOrigin', (w ? D : l).xOrigin, l.xOrigin, f, C), f = ua(D, 'yOrigin', (w ? D : l).yOrigin, l.yOrigin, f, C), (s !== D.xOffset || t !== D.yOffset) && (f = ua(D, 'xOffset', w ? s : D.xOffset, D.xOffset, f, C), f = ua(D, 'yOffset', w ? t : D.yOffset, D.yOffset, f, C)), E = '0px 0px'), (E || Fa && n && D.zOrigin) && (Ca ? (o = !0, v = Ea, E = (E || _(a, v, e, !1, '50% 50%')) + '', f = new ta(x, v, 0, 0, f, -1, C), f.b = x[v], f.plugin = h, Fa ? (m = D.zOrigin, E = E.split(' '), D.zOrigin = (E.length > 2 && (0 === m || '0px' !== E[2]) ? parseFloat(E[2]) : m) || 0, f.xs0 = f.e = E[0] + ' ' + (E[1] || '50%') + ' 0px', f = new ta(D, 'zOrigin', 0, 0, f, -1, f.n), f.b = m, f.xs0 = f.e = D.zOrigin) : f.xs0 = f.e = E) : ha(E + '', D)), o && (d._transformType = D.svg && Aa || !n && 3 !== this._transformType ? 2 : 3), j && (i[c] = j), k && (i.scale = k), f;
    }, prefix: !0}), ya('boxShadow', {defaultValue: '0px 0px 0px 0px #999', prefix: !0, color: !0, multi: !0, keyword: 'inset'}), ya('borderRadius', {defaultValue: '0px', parser: function(a, b, c, f, g, h) {
      ...
      for (q = parseFloat(a.offsetWidth), r = parseFloat(a.offsetHeight), i = b.split(' '), j = 0; j < y.length; j++)
        this.p.indexOf('border') && (y[j] = Z(y[j])), m = l = _(a, y[j], e, !1, '0px'), -1 !== m.indexOf(' ') && (l = m.split(' '), m = l[0], l = l[1]), n = k = i[j], o = parseFloat(m), t = m.substr((o + '').length), u = '=' === n.charAt(1), u ? (p = parseInt(n.charAt(0) + '1', 10), n = n.substr(2), p *= parseFloat(n), s = n.substr((p + '').length - (0 > p ? 1 : 0)) || '') : (p = parseFloat(n), s = n.substr((p + '').length)), '' === s && (s = d[c] || t), s !== t && (v = aa(a, 'borderLeft', o, t), w = aa(a, 'borderTop', o, t), '%' === s ? (m = v / q * 100 + '%', l = w / r * 100 + '%') : 'em' === s ? (x = aa(a, 'borderLeft', 1, 'em'), m = v / x + 'em', l = w / x + 'em') : (m = v + 'px', l = w + 'px'), u && (n = parseFloat(m) + p + s, k = parseFloat(l) + p + s)), g = va(z, y[j], m + ' ' + l, n + ' ' + k, !1, '0px', g); return g;
    }, prefix: !0, formatter: qa('0px 0px 0px 0px', !1, !0)}), ya('borderBottomLeftRadius,borderBottomRightRadius,borderTopLeftRadius,borderTopRightRadius', {defaultValue: '0px', parser: function(a, b, c, d, f, g) {
      return va(a.style, c, this.format(_(a, c, e, !1, '0px 0px')), this.format(b), !1, '0px', f);
    }, prefix: !0, formatter: qa('0px 0px', !1, !0)}), ya('backgroundPosition', {defaultValue: '0 0', parser: function(a, b, c, d, f, g) {
      var h,
          i,
          j,
          k,
      ...
      if (-1 !== q.indexOf('%') != (-1 !== r.indexOf('%')) && r.split(',').length < 2 && (m = _(a, 'backgroundImage').replace(D, ''), m && 'none' !== m)) {
        for (h = q.split(' '), i = r.split(' '), R.setAttribute('src', m), j = 2; --j > -1;)
          q = h[j], k = -1 !== q.indexOf('%'), k !== (-1 !== i[j].indexOf('%')) && (l = 0 === j ? a.offsetWidth - R.width : a.offsetHeight - R.height, h[j] = k ? parseFloat(q) / 100 * l + 'px' : parseFloat(q) / l * 100 + '%'); q = h.join(' ');
      } return this.parseComplex(a.style, q, r, f, g);
    }, formatter: ha}), ya('backgroundSize', {defaultValue: '0 0', formatter: function(a) {
    ...
    }}), ya('textShadow', {defaultValue: '0px 0px 0px #999', color: !0, multi: !0}), ya('autoRound,strictUnits', {parser: function(a, b, c, d, e) {
      return e;
    }}), ya('border', {defaultValue: '0px solid #000', parser: function(a, b, c, d, f, g) {
    ...
    ya('opacity,alpha,autoAlpha', {defaultValue: '1', parser: function(a, b, c, d, f, g) {
        ...
        Wa = function(a) {
          if (this.t._gsClassPT = this, 1 === a || 0 === a) {
            this.t.setAttribute('class', 0 === a ? this.b : this.e); for (var b = this.data, c = this.t.style; b;)
              b.v ? c[b.p] = b.v : Va(c, b.p), b = b._next; 1 === a && this.t._gsClassPT === this && (this.t._gsClassPT = null);
          } else
    ...
    ya('className', {parser: function(a, b, d, f, g, h, i) {
      ...
      if (g = f._classNamePT = new ta(a, d, 0, 0, g, 2), g.setRatio = Wa, g.pr = -11, c = !0, g.b = o, k = ca(a, e), l = a._gsClassPT) {
        for (m = {}, n = l.data; n;)
          m[n.p] = 1, n = n._next; l.setRatio(1);
      ...
      if ((1 === a || 0 === a) && this.data._totalTime === this.data._totalDuration && 'isFromStart' !== this.data.data) {
        ...
        if ('all' === this.e)
          ...
          for (b = this.e.split(' ').join('').split(','), d = b.length; --d > -1;)
            c = b[d], i[c] && (i[c].parse === h ? e = !0 : c = 'transformOrigin' === c ? Ea : i[c].p), Va(g, c); e && (Va(g, Ca), f = this.t._gsTransform, f && (f.svg && (this.t.removeAttribute('data-svg-origin'), this.t.removeAttribute('transform')), delete this.t._gsTransform));
      }
    };
    ...
    for (ya('clearProps', {parser: function(a, b, d, e, f) {
      ...
      za(j[wa]); j = g.prototype, j._firstPT = j._lastParsedTransform = j._transform = null, j._onInitTween = function(a, b, h, j) {
      if (!a.nodeType)
        return !1; this._target = q = a, this._tween = h, this._vars = b, r = j, k = b.autoRound, c = !1, d = b.suffixMap || g.suffixMap, e = $(a, ''), f = this._overwriteProps; var n,
          p,
          s,
          t,
          u,
      ...
      for (g in b) {
        if (n = b[g], 'function' == typeof n && (n = n(r, q)), h = i[g])
          c = h.parse(a, n, g, this, c, f, b); else {
          if ('--' === g.substr(0, 2)) {
            ...
            if (b = e.c * a + e.s, e.r ? b = e.r(b) : f > b && b > -f && (b = 0), e.type)
              if (1 === e.type)
                if (d = e.l, 2 === d)
                  ...
                  e.t[e.p] = e.xs0 + b + e.xs1 + e.xn1 + e.xs2 + e.xn2 + e.xs3 + e.xn3 + e.xs4 + e.xn4 + e.xs5; else {
                  for (c = e.xs0 + b + e.xs1, d = 1; d < e.l; d++)
                    c += e['xn' + d] + e['xs' + (d + 1)]; e.t[e.p] = c;
                } else
                -1 === e.type ? e.t[e.p] = e.xs0 : e.setRatio && e.setRatio(a); else
              e.t[e.p] = b + e.xs0; e = e._next;
          } else
          for (;e;)
          ...
          if (2 !== e.type)
            if (e.r && -1 !== e.type)
              if (b = e.r(e.s + e.c), e.type) {
                ...
                e.t[e.p] = b + e.xs0; else
              e.t[e.p] = e.e; else
            e.setRatio(a); e = e._next;
        }
    ...
    j._addLazySet = function(a, b, c) {
      ...
      if (b.autoAlpha || b.alpha) {
        f = {}; for (d in b)
          f[d] = b[d]; f.opacity = 1, f.autoAlpha && (f.visibility = 1);
        ...
        c.plugin && c.plugin !== d && c.plugin._kill && (c.plugin._kill(b), d = c.plugin), c = c._next; return a.prototype._kill.call(this, f);
    ...
    return g.cascadeTo = function(a, c, d) {
      ...
      for (a = i._targets || i.target, Za(a, k, m), i.render(c, !0, !0), Za(a, l), i.render(0, !0, !0), i._enabled(!0), e = m.length; --e > -1;)
        if (f = da(m[e], k[e], l[e]), f.firstMPT) {
          f = f.difs; for (g in d)
            n[g] && (f[g] = d[g]); h = {}; for (g in f)
            h[g] = k[e][g]; j.push(b.fromTo(m[e], c, h, f));
        } return j;
    }, a.activate([g]), g;
  }, !0), function() {
    var a = _gsScope._gsDefine.plugin({propName: 'roundProps', version: '1.7.0', priority: -1, API: 2, init: function(a, b, c) {
    ...
    d._onInitAllProps = function() {
      ...
      if ('object' != typeof h || h.push)
        for ('string' == typeof h && (h = h.split(',')), e = h.length; --e > -1;)
          i[h[e]] = Math.round; else
        for (f in h)
          i[f] = b(h[f]); for (f in i)
        for (a = g._firstPT; a;)
          d = a._next, a.pg ? a.t._mod(i) : a.n === f && (2 === a.f && a.t ? c(a.t._firstPT, i[f]) : (this._add(a.t, f, a.s, a.c, i[f]), d && (d._prev = a._prev), a._prev ? a._prev._next = d : g._firstPT === a && (g._firstPT = d), a._next = a._prev = null, g._propLookup[f] = j)), a = d; return !1;
    ...
    'object' != typeof b && (b = {rotation: b}), this.finals = {}; var e,
        f,
        g,
        h,
        i,
    ...
    if (1 !== a)
      this._super.setRatio.call(this, a); else
    ...
    return r.constructor = q, r.getRatio = function(a) {
      ...
      b = b || {}; for (var c, d, e, f, g, h, i = b.taper || 'none', j = [], k = 0, l = 0 | (b.points || 20), m = l, o = b.randomize !== !1, p = b.clamp === !0, q = b.template instanceof a ? b.template : null, r = 'number' == typeof b.strength ? .4 * b.strength : .4; --m > -1;)
        c = o ? Math.random() : 1 / l * m, d = q ? q.getRatio(c) : c, 'none' === i ? e = r : 'out' === i ? (f = 1 - c, e = f * f * r) : 'in' === i ? e = c * c * r : .5 > c ? (f = 2 * c, e = f * f * .5 * r) : (f = 2 * (1 - c), e = f * f * .5 * r), o ? d += Math.random() * e - .5 * e : m % 2 ? d += .5 * e : d -= .5 * e, p && (d > 1 ? d = 1 : 0 > d && (d = 0)), j[k++] = {x: c, y: d}; for (j.sort(function(a, b) {
        return a.x - b.x;
      }), h = new n(1, 1, null), m = l; --m > -1;)
        g = j[m], h = new n(g.x, g.y, h); this._prev = new n(0, 0, 0 !== h.t ? h : h.next);
      ...
      if (a > b.t) {
        ...
        for (;b.prev && a <= b.t;)
          b = b.prev; return this._prev = b, b.v + (a - b.t) / b.gap * b.c;
    }, r.config = function(a) {
      return new d(a);
    ...
    })), j('easing.EaseLookup', {find: function(b) {
      return a.map[b];
  ...
  if (f)
    return 'undefined' != typeof module && module.exports && (module.exports = f), f; var g,
      h,
      i,
      j,
      k,
      ...
      r = {},
      s = function(d, f, g, h) {
        this.sc = r[d] ? r[d].sc : [], r[d] = this, this.gsClass = null, this.func = g; var i = [];

        this.check = function(j) {
          for (var k, m, n, o, p = f.length, q = p; --p > -1;)
            (k = r[f[p]] || new s(f[p], [])).gsClass ? (i[p] = k.gsClass, q--) : j && k.sc.push(this); if (0 === q && g) {
  ...
  for (i = w.prototype, i._calcEnd = !1, i.getRatio = function(a) {
    if (this._func)
      return this._params[0] = a, this._func.apply(null, this._params); var b = this._type,
        c = this._power,
        d = 1 === b ? 1 - a : 2 === b ? a : .5 > a ? 2 * a : 2 * (1 - a);

    return 1 === c ? d *= d : 2 === c ? d *= d * d : 3 === c ? d *= d * d * d : 4 === c && (d *= d * d * d * d), 1 === b ? 1 - d : 2 === b ? d : .5 > a ? d / 2 : 1 - d / 2;
  }, g = [ 'Linear', 'Quad', 'Cubic', 'Quart', 'Quint,Strong' ], h = g.length; --h > -1;)
    i = g[h] + ',Power' + h, y(new w(null, null, 1, h), i, 'easeOut', !0), y(new w(null, null, 2, h), i, 'easeIn' + (0 === h ? ',easeNone' : '')), y(new w(null, null, 3, h), i, 'easeInOut'); x.linear = m.easing.Linear.easeIn, x.swing = m.easing.Quad.easeInOut; var z = u('events.EventDispatcher', function(a) {
  ...
  i = z.prototype, i.addEventListener = function(a, b, c, d, e) {
    ...
    for (this !== j || k || j.wake(), null == h && (this._listeners[a] = h = []), g = h.length; --g > -1;)
      f = h[g], f.c === b && f.s === c ? h.splice(g, 1) : 0 === i && f.pr < e && (i = g + 1); h.splice(i, 0, {c: b, s: c, up: d, pr: e});
  ...
  for (g = [ 'ms', 'moz', 'webkit', 'o' ], h = g.length; --h > -1 && !A;)
    A = a[g[h] + 'RequestAnimationFrame'], B = a[g[h] + 'CancelAnimationFrame'] || a[g[h] + 'CancelRequestAnimationFrame']; u('Ticker', function(a, b) {
    var c,
        e,
        f,
        g,
    ...
    if (this.vars = b = b || {}, this._duration = this._totalDuration = a || 0, this._delay = Number(b.delay) || 0, this._timeScale = 1, this._active = b.immediateRender === !0, this.data = b.data, this._reversed = b.reversed === !0, Y) {
      k || j.wake(); var c = this.vars.useFrames ? X : Y;
  ...
  j = E.ticker = new m.Ticker, i = E.prototype, i._dirty = i._gc = i._initted = i._paused = !1, i._totalTime = i._time = 0, i._rawPrevTime = -1, i._next = i._last = i._onUpdate = i._timeline = i.timeline = null, i._paused = !1; var F = function() {
    k && C() - D > 2e3 && ('hidden' !== (d || {}).visibilityState || !j.lagSmoothing()) && j.wake(); var a = setTimeout(F, 2e3);
  ...
  F(), i.play = function(a, b) {
    ...
    for (var b = a ? this : this.timeline; b;)
      b._dirty = !0, b = b.timeline; return this;
  }, i._swapSelfInParams = function(a) {
    for (var b = a.length, c = a.concat(); --b > -1;)
      '{self}' === a[b] && (c[b] = this); return c;
    ...
    if ('on' === (a || '').substr(0, 2)) {
      ...
      if (1 === arguments.length)
        return e[a]; null == b ? delete e[a] : (e[a] = b, e[a + 'Params'] = q(c) && -1 !== c.join('').indexOf('{self}') ? this._swapSelfInParams(c) : c, e[a + 'Scope'] = d), 'onUpdate' === a && (this._onUpdate = b);
    } return this;
  }, i.delay = function(a) {
    ...
    for (a = a || n, this._timeline && this._timeline.smoothChildTiming && (b = this._pauseTime, c = b || 0 === b ? b : this._timeline.totalTime(), this._startTime = c - (c - this._startTime) * this._timeScale / a), this._timeScale = a, c = this.timeline; c && c.timeline;)
      c._dirty = !0, c.totalDuration(), c = c.timeline; return this;
  }, i.reversed = function(a) {
    return arguments.length ? (a != this._reversed && (this._reversed = a, this.totalTime(this._timeline && !this._timeline.smoothChildTiming ? this.totalDuration() - this._totalTime : this._totalTime, !0)), this) : this._reversed;
  }, i.paused = function(a) {
    if (!arguments.length)
      return this._paused; var b,
        c,
        d = this._timeline;
  ...
  i = G.prototype = new E, i.constructor = G, i.kill()._gc = !1, i._first = i._last = i._recent = null, i._sortChildren = !1, i.add = i.insert = function(a, b, c, d) {
    ...
    if (a._startTime = Number(b || 0) + a._delay, a._paused && this !== a._timeline && (a._pauseTime = this.rawTime() - (a._timeline.rawTime() - a._pauseTime)), a.timeline && a.timeline._remove(a, !0), a.timeline = a._timeline = this, a._gc && a._enabled(!0, !0), e = this._last, this._sortChildren)
      for (f = a._startTime; e && e._startTime > f;)
        e = e._prev; return e ? (a._next = e._next, e._next = a) : (a._next = this._first, this._first = a), a._next ? a._next._prev = a : this._last = a, a._prev = e, this._recent = a, this._timeline && this._uncache(!0), this;
    ...
    return k || j.wake(), this._totalTime;
        ...
        if (E.call(this, c, d), this.render = H.prototype.render, null == b)
          throw 'Cannot tween a null target.'; this.target = b = 'string' != typeof b ? b : H.selector(b) || b; var e,
            f,
            g,
        ...
        if (this._overwrite = i = null == i ? W[H.defaultOverwrite] : 'number' == typeof i ? i >> 0 : W[i], (h || b instanceof Array || b.push && q(b)) && 'number' != typeof b[0])
          for (this._targets = g = o(b), this._propLookup = [], this._siblings = [], e = 0; e < g.length; e++)
            f = g[e], f ? 'string' != typeof f ? f.length && f !== a && f[0] && (f[0] === a || f[0].nodeType && f[0].style && !f.nodeType) ? (g.splice(e--, 1), this._targets = g = g.concat(o(f))) : (this._siblings[e] = _(f, this, !1), 1 === i && this._siblings[e].length > 1 && ba(f, this, null, 1, this._siblings[e])) : (f = g[e--] = H.selector(f), 'string' == typeof f && g.splice(e + 1, 1)) : g.splice(e--, 1); else
          this._propLookup = {}, this._siblings = _(b, this, !1), 1 === i && this._siblings.length > 1 && ba(b, this, null, 1, this._siblings); (this.vars.immediateRender || 0 === c && 0 === this._delay && this.vars.immediateRender !== !1) && (this._time = -n, this.render(Math.min(0, -this._delay)));
      }, !0),
      I = function(b) {
      ...
      J = function(a, b) {
        ...
        for (c in a)
          V[c] || c in b && 'transform' !== c && 'x' !== c && 'y' !== c && 'width' !== c && 'height' !== c && 'className' !== c && 'border' !== c || !(!S[c] || S[c] && S[c]._autoCSS) || (d[c] = a[c], delete a[c]); a.css = d;
      };
  ...
  i = H.prototype = new E, i.constructor = H, i.kill()._gc = !1, i.ratio = 0, i._firstPT = i._targets = i._overwrittenProps = i._startAt = null, i._notifyPluginsOfEnabled = i._lazy = !1, H.version = '2.0.2', H.defaultEase = i._ease = new w(null, null, 1, 1), H.defaultOverwrite = 'auto', H.ticker = j, H.autoSleep = 120, H.lagSmoothing = function(a, b) {
    ...
    return c ? (H.selector = c, c(b)) : (d || (d = a.document), d ? d.querySelectorAll ? d.querySelectorAll(b) : d.getElementById('#' === b.charAt(0) ? b.substr(1) : b) : b);
      ...
      Q = function(a, b, c, d, e, f, g, h, i) {
        ...
        return ('number' != typeof m || 'number' != typeof d && !n) && (g || isNaN(m) || !n && isNaN(d) || 'boolean' == typeof m || 'boolean' == typeof d ? (o.fp = g, j = P(m, n ? parseFloat(o.s) + o.c + (o.s + '').replace(/[0-9\-\.]/g, '') : d, h || H.defaultStringFilter, o), o = {t: j, p: 'setRatio', s: 0, c: 1, f: 2, pg: 0, n: e || b, pr: 0, m: 0}) : (o.s = parseFloat(m), n || (o.c = parseFloat(d) - o.s || 0))), o.c ? ((o._next = this._firstPT) && (o._next._prev = o), this._firstPT = o, o) : void 0;
      },
      ...
      $ = R.lazyRender = function() {
        ...
        for (L = {}; --b > -1;)
          a = K[b], a && a._lazy !== !1 && (a.render(a._lazy[0], a._lazy[1], !0), a._lazy = !1); K.length = 0;
      };
  ...
  Y._startTime = j.time, X._startTime = j.frame, Y._active = X._active = !0, setTimeout($, 1), E._updateRoot = H.render = function() {
    ...
    if (K.length && $(), Y.render((j.time - Y._startTime) * Y._timeScale, !1, !1), X.render((j.frame - X._startTime) * X._timeScale, !1, !1), K.length && $(), j.frame >= Z) {
      Z = j.frame + (parseInt(H.autoSleep, 10) || 120); for (c in T) {
        ...
        if (T[f || (a._gsTweenID = f = 't' + U++)] || (T[f] = {target: a, tweens: []}), b && (d = T[f].tweens, d[e = d.length] = b, c))
          for (;--e > -1;)
            d[e] === b && d.splice(e, 1); return T[f].tweens;
      },
      aa = function(a, b, c, d) {
        var e,
            f,
      ...
      ba = function(a, b, c, d, e) {
        ...
        if (1 === d || d >= 4) {
          for (i = e.length, f = 0; i > f; f++)
            if ((h = e[f]) !== b)
              h._gc || h._kill(null, a, b) && (g = !0); else if (5 === d)
              break; return g;
        } var j,
            k = b._startTime + n,
            l = [],
        ...
        for (f = e.length; --f > -1;)
          (h = e[f]) === b || h._gc || h._paused || (h._timeline !== b._timeline ? (j = j || ca(b, 0, o), 0 === ca(h, j, o) && (l[m++] = h)) : h._startTime <= k && h._startTime + h.totalDuration() / h._timeScale > k && ((o || !h._initted) && k - h._startTime <= 2e-10 || (l[m++] = h))); for (f = m; --f > -1;)
  ...
  i._init = function() {
    ...
    if (g.startAt) {
      this._startAt && (this._startAt.render(-1, !0), this._startAt.kill()), e = {}; for (d in g.startAt)
        e[d] = g.startAt[d]; if (e.data = 'isStart', e.overwrite = !1, e.immediateRender = !0, e.lazy = j && g.lazy !== !1, e.startAt = e.delay = null, e.onUpdate = g.onUpdate, e.onUpdateParams = g.onUpdateParams, e.onUpdateScope = g.onUpdateScope || g.callbackScope || this, this._startAt = H.to(this.target || {}, 0, e), j)
        if (this._time > 0)
          this._startAt = null; else if (0 !== i)
          return;
    } else if (g.runBackwards && 0 !== i)
      if (this._startAt)
        this._startAt.render(-1, !0), this._startAt.kill(), this._startAt = null; else {
        0 !== this._time && (j = !1), c = {}; for (d in g)
          V[d] && 'autoCSS' !== d || (c[d] = g[d]); if (c.overwrite = 0, c.data = 'isFromStart', c.lazy = j && g.lazy !== !1, c.immediateRender = j, this._startAt = H.to(this.target, 0, c), j) {
          if (0 === this._time)
            return;
        } else
      ...
      b = this._initProps(this.target, this._propLookup, this._siblings, h, 0); if (b && H._onPluginEvent('_onInitAllProps', this), h && (this._firstPT || 'function' != typeof this.target && this._enabled(!1, !1)), g.runBackwards)
      for (c = this._firstPT; c;)
        c.s += c.c, c.c = -c.c, c = c._next; this._onUpdate = g.onUpdate, this._initted = !0;
    ...
    if (null == b)
      return !1; L[b._gsTweenID] && $(), this.vars.css || b.style && b !== a && b.nodeType && S.css && this.vars.autoCSS !== !1 && J(this.vars, b); for (g in this.vars)
      if (l = this.vars[g], V[g])
        l && (l instanceof Array || l.push && q(l)) && -1 !== l.join('').indexOf('{self}') && (this.vars[g] = l = this._swapSelfInParams(l, this)); else if (S[g] && (j = new S[g])._onInitTween(b, this.vars[g], this, f)) {
        for (this._firstPT = k = {_next: this._firstPT, t: j, p: 'setRatio', s: 0, c: 1, f: 1, n: g, pg: 1, pr: j._priority, m: 0}, h = j._overwriteProps.length; --h > -1;)
          c[j._overwriteProps[h]] = this._firstPT; (j._priority || j._onInitAllProps) && (i = !0), (j._onDisable || j._onEnable) && (this._notifyPluginsOfEnabled = !0), k._next && (k._next._prev = k);
      } else
        c[g] = Q.call(this, b, g, 'get', l, g, 0, null, this.vars.stringFilter, f); return e && this._kill(e, b) ? this._initProps(b, c, d, e, f) : this._overwrite > 1 && this._firstPT && d.length > 1 && ba(b, this, c, this._overwrite, d) ? (this._kill(c, b), this._initProps(b, c, d, e, f)) : (this._firstPT && (this.vars.lazy !== !1 && this._duration || this.vars.lazy && !this._duration) && (L[b._gsTweenID] = !0), i);
  }, i.render = function(a, b, c) {
    var d,
        e,
        f,
    ...
    if (a >= i - 1e-7 && a >= 0)
      this._totalTime = this._time = i, this.ratio = this._ease._calcEnd ? this._ease.getRatio(1) : 1, this._reversed || (d = !0, e = 'onComplete', c = c || this._timeline.autoRemoveChildren), 0 === i && (this._initted || !this.vars.lazy || c) && (this._startTime === this._timeline._duration && (a = 0), (0 > j || 0 >= a && a >= -1e-7 || j === n && 'isPause' !== this.data) && j !== a && (c = !0, j > n && (e = 'onReverseComplete')), this._rawPrevTime = g = !b || a || j === a ? a : n); else if (1e-7 > a)
      this._totalTime = this._time = 0, this.ratio = this._ease._calcEnd ? this._ease.getRatio(0) : 0, (0 !== h || 0 === i && j > 0) && (e = 'onReverseComplete', d = this._reversed), 0 > a && (this._active = !1, 0 === i && (this._initted || !this.vars.lazy || c) && (j >= 0 && (j !== n || 'isPause' !== this.data) && (c = !0), this._rawPrevTime = g = !b || a || j === a ? a : n)), (!this._initted || this._startAt && this._startAt.progress()) && (c = !0); else if (this._totalTime = this._time = a, this._easeType) {
      var k = a / i,
          l = this._easeType,
          m = this._easePower;
      ...
      this.ratio = this._ease.getRatio(a / i); if (this._time !== h || c) {
      if (!this._initted) {
        if (this._init(), !this._initted || this._gc)
    ...
    if ('all' === a && (a = null), null == a && (null == b || b === this.target))
      return this._lazy = !1, this._enabled(!1, !1); b = 'string' != typeof b ? b || this._targets || this.target : H.selector(b) || b; var d,
        e,
        f,
        g,
        h,
    ...
    if ((q(b) || I(b)) && 'number' != typeof b[0])
      ...
      if (this._targets) {
        ...
        if (b !== this.target)
          return !1; h = this._propLookup, e = this._overwrittenProps = a ? this._overwrittenProps || {} : 'all';
      } if (h) {
        if (j = a || h, k = a !== e && 'all' !== e && a !== h && ('object' != typeof a || !a._tempKill), c && (H.onOverwrite || this.vars.onOverwrite)) {
          ...
          (g = h[f]) && (m && (g.f ? g.t[g.p](g.s) : g.t[g.p] = g.s, i = !0), g.pg && g.t._kill(j) && (i = !0), g.pg && 0 !== g.t._overwriteProps.length || (g._prev ? g._prev._next = g._next : g === this._firstPT && (this._firstPT = g._next), g._next && (g._next._prev = g._prev), g._next = g._prev = null), delete h[f]), k && (e[f] = 1); !this._firstPT && this._initted && n && this._enabled(!1, !1);
      }
    } return i;
    ...
    if (k || j.wake(), a && this._gc) {
      ...
      if (d)
        for (c = d.length; --c > -1;)
          this._siblings[c] = _(d[c], this, !0); else
    ...
    if (null == a)
      return []; a = 'string' != typeof a ? a : H.selector(a) || a; var c,
        d,
        e,
        f;
    ...
    if ((q(a) || I(a)) && 'number' != typeof a[0]) {
      ...
      for (d = _(a).concat(), c = d.length; --c > -1;)
        (d[c]._gc || b && !d[c].isActive()) && d.splice(c, 1); return d || [];
  }, H.killTweensOf = H.killDelayedCallsTo = function(a, b, c) {
    'object' == typeof b && (c = b, b = !1); for (var d = H.getTweensOf(a, b), e = d.length; --e > -1;)
      d[e]._kill(c, a);
  ...
  if (i = da.prototype, da.version = '1.19.0', da.API = 2, i._firstPT = null, i._addTween = Q, i.setRatio = O, i._kill = function(a) {
    ...
    if (null != a[this._propName])
      ...
      null != a[d.n] && (d._next && (d._next._prev = d._prev), d._prev ? (d._prev._next = d._next, d._prev = null) : this._firstPT === d && (this._firstPT = d._next)), d = d._next; return !1;
    ...
    if ('_onInitAllProps' === a) {
      ...
      h.pg && 'function' == typeof h.t[a] && h.t[a]() && (c = !0), h = h._next; return c;
  }, da.activate = function(a) {
    for (var b = a.length; --b > -1;)
      a[b].API === da.API && (S[(new a[b])._propName] = a[b]); return !0;
  }, t.plugin = function(a) {
    if (!(a && a.propName && a.init && a.API))
      throw 'illegal plugin definition.'; var b,
        c = a.propName,
        d = a.priority || 0,
        e = a.overwriteProps,
    ...
    h.constructor = g, g.API = a.API; for (b in f)
      'function' == typeof a[b] && (h[f[b]] = a[b]); return g.version = a.version, da.activate([g]), g;
  }, g = a._gsQueue) {
