  ...
  methods: {
    ...
    async disconnectSMS() {
      ...
      try {
        ...
        _alert("You have sucessfully disconnected your SMS verification.", "success", 3000);
      }
    },
  ...
  methods: {
    ...
    async disconnectTwitter() {
      ...
      try {
        ...
        this.awaitingResponse = false;
        this.dismissVerification();
        _alert("You have sucessfully disconnected from Twitter.", "success", 3000);
      }
    }
  }
});
  ...
  methods: {
    ...
    async disconnectPOAP() {
      ...
      try {
        ...
        this.awaitingResponse = false;
        this.dismissVerification();
        _alert("You have sucessfully disconnected from POAP.", "success", 3000);
      }
    },
    clickedClose() {
      this.$emit('modal-dismissed');
  ...
  methods: {
    ...
    async disconnectPOH() {
      ...
      try {
        ...
        this.awaitingResponse = false;
        this.dismissVerification();
        _alert("You have sucessfully disconnected from POH.", "success", 3000);
      }
    }
  }
});
  ...
  methods: {
    ...
    async disconnectBrightid() {
      ...
      try {
        ...
        this.awaitingResponse = false;
        this.dismissVerification();
        _alert("You have sucessfully disconnected from BrightID.", "success", 3000);
      }
    }
  }
});
    ...
    async checkApi(url, checkingStatus) {
      ...
      try {
        ...
        if (url === this.service.logout_url) {
          _alert("You have sucessfully disconnected from Idena.", "success", 3000);
        }
      }
    }
  }
  ...
  methods: {
    ...
    async disconnectENS() {
      ...
      try {
        ...
        this.awaitingResponse = false;
        this.dismissVerification();
        _alert("You have sucessfully disconnected from ENS.", "success", 3000);
      }
    }
  }
});
  ...
  methods: {
    ...
    async disconnectGoogle() {
      ...
      try {
        ...
        this.awaitingResponse = false;
        this.dismissVerification();
        _alert("You have sucessfully disconnected from Google.", "success", 3000);
      }
    }
  }
});
  ...
  methods: {
    ...
    async disconnectFacebook() {
      ...
      try {
        ...
        this.awaitingResponse = false;
        this.dismissVerification();
        _alert("You have sucessfully disconnected from Facebook.", "success", 3000);
      }
    }
  }
});
