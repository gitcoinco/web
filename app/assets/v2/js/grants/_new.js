...
Vue.mixin({
  methods: {
    ...
    checkForm: function(e) {
      ...
      } else if (vm.chainId == 'edgeware' && !vm.form.edgeware_payout_address) {
        vm.$set(vm.errors, 'edgeware_payout_address', 'Please enter Edgeware address');
      }
    ...
    submitForm: async function(event) {
      ...
      const params = {
        ...
        'edgeware_payout_address': form.edgeware_payout_address,
