...
Vue.component('project-card', {
  ...
  template: `<div class="card card-user shadow-sm border-0">
    <div class="card card-project">
      ...
      <img v-if="project.grant_link" class="position-absolute" style="left: 1rem" src="${static_url}v2/images/grants/grants-tag.svg" alt="grant_tag"/>
      ...
      <div class="card-body">
        <a :href="project_url" target="_blank"><h5 class="text-black card-title font-weight-bold text-left">[[ project.name ]]</h5></a>
        <div class="my-2">
        ...
        <div class="my-3 mb-2 d-flex justify-content-between">
          <div class="mt-1">
