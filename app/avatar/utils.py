        ...
        'sections': [{
            ...
            'paid_options': {}
        },
                    {
                        ...
                        'options': (
                            'ziggy-stardust', 'bolt', 'star2', 'kiss', 'blush', 'eyeliner-green', 'eyeliner-teal', 'eyeliner-pink', 'eyeliner-red', 'eyeliner-blue', 'star'
                        ),
                        'paid_options': {
                            'ziggy-stardust': 0.02,
                            'bolt': 0.01,
                        ...
                        'options': (['None', '0'], ['None', '1'], ['None', '2'], ['None', '3'], ['None', '4'], ['5', 'None'], ['6-back', '6-front'], ['7-back', '7-front'], ['8-back', '8-front'], ['9-back', '9-front'], ['None', '10'], ['damos_hair-back', 'damos_hair-front'], [
                        ...
                        'options': (['Glasses-0'], ['Glasses-1'], ['Glasses-2'], ['Glasses-3'], ['Glasses-4'], [
                            ...
                            'HatShort-headdress'
                                    ...
                                    ['EarringBack-2', 'Earring-2'], ['Earring-3'], ['Earring-4'], ['Masks-jack-o-lantern'], [
                                        'Masks-guy-fawkes'
                                    ], ['Masks-jack-o-lantern-lighted'], ['Extras-Parrot'], ['Masks-gitcoinbot'], ['Masks-batman']),
                        'paid_options': {
                            'Extras-Parrot': 0.01,
                            'Masks-batman': 0.02
                        },
                        ...
                        'options': (
                            '25E899', '9AB730', '00A55E', '3FCDFF', '3E00FF', '8E2ABE', 'D0021B', 'F9006C', 'FFCE08', 'F8E71C', '15003E', 'FFFFFF'
                        ),
                        'paid_options': {},
                    }, {
                        'name': 'Wallpaper',
                        ...
                        'options': (
                            'anchors', 'circuit', 'jigsaw', 'lines', 'gears', 'clouds', 'signal', 'polka_dots', 'polka_dots_black', 'squares', 'shapes', 'sunburst', 'sunburst_pastel', 'rainbow'
                        ),
                        'paid_options': {
