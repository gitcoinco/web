...
import cssutils
import premailer
from grants.models import Grant, Subscription, Contribution
...
def render_successful_contribution_email(grant, subscription, contribution):
    ...
    subject = f'Your contribution of {{ subscription.amount_per_period }} {{ subscription.token_symbol }} to {{ grant.title }} was successful!'
    return response_html, response_txt, subject
