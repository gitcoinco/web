...
def index(request):
    slides = [
            ("Kevin Owocki","/static/v2/images/avatar.png", "I feel it is so awesome to have the opportunity through Gitcoin to do what I love and get paid for it, and to have reasonable freedom about the way I work, that it already seems too good to be true."),
            ("Kevin Owocki","/static/v2/images/avatar.png", "This could be the next freelance boom."),
            ("Kevin Owocki","/static/v2/images/avatar.png", "We've had 2 bounties fulfilled and we're hooked."),
