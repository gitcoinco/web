# Generated by Django 2.0.7 on 2018-08-25 23:04
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recipient_profile', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='received_kudos', to='dashboard.Profile')),
                ('sender_profile', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='sent_kudos', to='dashboard.Profile')),
            ],
            options={
                'abstract': False,
            },
