...
def receive(request, key, txid, network):
    ...
    if kudos_transfer.receive_txid:
        ...
        message = mark_safe(
            f'The transaction is still mining.'
            '<a href="https://etherscan.io/tx/{txid}">[View on Etherscan]</a>'
            '<a href="https://blockscout.com/eth/mainnet/tx/{txid}">[View on Blockscout]</a>'
