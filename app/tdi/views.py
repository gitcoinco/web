...
https://gitcoin.co/_administration/tdi/whitepaperaccessrequest/
    ...
    send_mail(settings.CONTACT_EMAIL, settings.CONTACT_EMAIL, _("New Whitepaper Request"), str(body), categories=['admin', 'whitepaper_request'])
...
def whitepaper_access(request, ratelimited=False):
    ...
    send_mail(settings.CONTACT_EMAIL, settings.CONTACT_EMAIL, _("New Whitepaper Generated"), str(wa), categories=['admin', 'whitepaper_gen'])
...
def process_accesscode_request(request, pk):
    ...
    if request.POST.get('submit', False):
        ...
        try:
            ...
            send_mail(from_email, to_email, subject, body, from_name=_("Kevin from Gitcoin.co"), categories=['admin', 'access_code_request'])
