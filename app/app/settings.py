...
SOCIAL_AUTH_PIPELINE = (
    ...
    'social_core.pipeline.user.get_username', 'social_core.pipeline.user.create_user', 'app.auth_pipeline.save_profile',
...
# Django Pipeline
PIPELINE['PIPELINE_ENABLED'] = env.bool('PIPELINE_ENABLED', default=True)
PIPELINE['PIPELINE_COLLECTOR_ENABLED'] = env.bool('PIPELINE_COLLECTOR_ENABLED', default=True)
