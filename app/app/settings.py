...
FORTMATIC_LIVE_KEY = env(
    "FORTMATIC_LIVE_KEY", default="YOUR-SupEr-SecRet-LiVe-FoRtMaTiC-KeY"
)
FORTMATIC_TEST_KEY = env(
    "FORTMATIC_TEST_KEY", default="YOUR-SupEr-SecRet-TeSt-FoRtMaTiC-KeY"
)
...
if ENV in ["prod", "stage"]:
    DEFAULT_FILE_STORAGE = env(
        "DEFAULT_FILE_STORAGE", default="app.static_storage.MediaFileStorage"
    )
    THUMBNAIL_DEFAULT_STORAGE = DEFAULT_FILE_STORAGE
    STATICFILES_STORAGE = env(
        "STATICFILES_STORAGE", default="app.static_storage.SilentFileStorage"
    )
    STATIC_HOST = env("STATIC_HOST", default="https://s.gitcoin.co/")
    STATIC_URL = STATIC_HOST + env(
        "STATIC_URL",
        default=f'{STATICFILES_LOCATION}{"/" if STATICFILES_LOCATION else ""}',
    )
    MEDIA_URL = env(
        "MEDIA_URL",
        default=f'https://c.gitcoin.co/{MEDIAFILES_LOCATION}{"/" if MEDIAFILES_LOCATION else ""}',
    )
else:
...
THUMBNAIL_ALIASES = {
    "": {
        "graph_node": {"size": (30, 30), "crop": True},
        "graph_node_circular": {"size": (30, 30), "crop": True, "circle": True},
    }
}
...
DJANGO_REDIS_LOG_IGNORED_EXCEPTIONS = env.bool(
    "REDIS_LOG_IGNORED_EXCEPTIONS", default=True
)
...
CACHES = {
    ...
    COLLECTFAST_CACHE: env.cache(
        "COLLECTFAST_CACHE_URL", default="dbcache://collectfast"
    ),
...
GITHUB_AUTH_BASE_URL = env(
    "GITHUB_AUTH_BASE_URL", default="https://github.com/login/oauth/authorize"
)
GITHUB_TOKEN_URL = env(
...
KUDOS_REVENUE_ACCOUNT_ADDRESS = env(
    "KUDOS_REVENUE_ACCOUNT_ADDRESS",
    default="0xdb282cee382244e05dd226c8809d2405b76fbdc9",
)

# Chat
CHAT_PORT = env("CHAT_PORT", default=8065)  # port of where mattermost is hosted
CHAT_URL = env(
    "CHAT_URL", default="localhost"
)  # location of where mattermost is hosted
CHAT_SERVER_URL = env(
    "CHAT_SERVER_URL", default="chat"
)  # location of where mattermost is hosted
...
DISPUTES_TWITTER_CONSUMER_SECRET = env(
    "DISPUTES_TWITTER_CONSUMER_SECRET", default=""
)  # TODO
DISPUTES_TWITTER_ACCESS_TOKEN = env("DISPUTES_TWITTER_ACCESS_TOKEN", default="")  # TODO
DISPUTES_TWITTER_ACCESS_SECRET = env(
    "DISPUTES_TWITTER_ACCESS_SECRET", default=""
)  # TODO
...
# Kudos
KUDOS_OWNER_ACCOUNT = env(
    "KUDOS_OWNER_ACCOUNT", default="0xD386793F1DB5F21609571C0164841E5eA2D33aD8"
)
KUDOS_PRIVATE_KEY = env("KUDOS_PRIVATE_KEY", default="")
KUDOS_CONTRACT_MAINNET = env(
    "KUDOS_CONTRACT_MAINNET", default="0x2aea4add166ebf38b63d09a75de1a7b94aa24163"
)
KUDOS_CONTRACT_RINKEBY = env(
    "KUDOS_CONTRACT_RINKEBY", default="0x4077ae95eec529d924571d00e81ecde104601ae8"
)
KUDOS_CONTRACT_ROPSTEN = env(
    "KUDOS_CONTRACT_ROPSTEN", default="0xcd520707fc68d153283d518b29ada466f9091ea8"
)
KUDOS_CONTRACT_TESTRPC = env(
    "KUDOS_CONTRACT_TESTRPC", default="0x38c48d14a5bbc38c17ced9cd5f0695894336f426"
)
KUDOS_NETWORK = env("KUDOS_NETWORK", default="mainnet")

# Grants
GRANTS_OWNER_ACCOUNT = env(
    "GRANTS_OWNER_ACCOUNT", default="0xD386793F1DB5F21609571C0164841E5eA2D33aD8"
)
GRANTS_PRIVATE_KEY = env("GRANTS_PRIVATE_KEY", default="")
GRANTS_SPLITTER_ROPSTEN = env(
    "GRANTS_SPLITTER_ROPSTEN", default="0xe2fd6dfe7f371e884e782d46f043552421b3a9d9"
)
GRANTS_SPLITTER_MAINNET = env(
    "GRANTS_SPLITTER_MAINNET", default="0xdf869FAD6dB91f437B59F1EdEFab319493D4C4cE"
)
GRANTS_NETWORK = env("GRANTS_NETWORK", default="mainnet")
GITCOIN_DONATION_ADDRESS = env(
    "GITCOIN_DONATION_ADDRESS", default="0x00De4B13153673BCAE2616b67bf822500d325Fc3"
)
...
GOOGLE_ANALYTICS_AUTH_JSON = {
    ...
    "token_uri": env(
        "GA_TOKEN_URI", default="https://accounts.google.com/o/oauth2/token"
    ),
...
# Faucet App config
FAUCET_AMOUNT = env.float("FAUCET_AMOUNT", default=0.00025)
...
INFURA_V3_PROJECT_ID = env(
    "INFURA_V3_PROJECT_ID", default="1e0a90928efe4bb78bb1eeceb8aacc27"
)
...
if ENABLE_SILK:
    ...
    SILKY_PYTHON_PROFILER_BINARY = env.bool(
        "SILKY_PYTHON_PROFILER_BINARY", default=False
    )
...
MINICLR_ADDRESS = env(
    "MINICLR_ADDRESS", default="0x00De4B13153673BCAE2616b67bf822500d325Fc3"
)
MINICLR_PRIVATE_KEY = env(
    "MINICLR_PRIVATE_KEY", default="0x00De4B13153673BCAE2616b67bf822500d325Fc3"
)


AVATAR_ADDRESS = env(
    "AVATAR_ADDRESS", default="0x00De4B13153673BCAE2616b67bf822500d325Fc3"
)
AVATAR_PRIVATE_KEY = env(
    "AVATAR_PRIVATE_KEY", default="0x00De4B13153673BCAE2616b67bf822500d325Fc3"
)

GRANTS_PAYOUT_ADDRESS = env(
    "GRANTS_PAYOUT_ADDRESS", default="0x00De4B13153673BCAE2616b67bf822500d325Fc3"
)
GRANTS_PAYOUT_PRIVATE_KEY = env(
    "GRANTS_PAYOUT_PRIVATE_KEY", default="0x00De4B13153673BCAE2616b67bf822500d325Fc3"
)
...
TIP_PAYOUT_ADDRESS = env(
    "TIP_PAYOUT_ADDRESS", default="0x00De4B13153673BCAE2616b67bf822500d325Fc3"
)
TIP_PAYOUT_PRIVATE_KEY = env(
    "TIP_PAYOUT_PRIVATE_KEY", default="0x00De4B13153673BCAE2616b67bf822500d325Fc3"
)
...
HYPERCHARGE_BOUNTIES_PROFILE_HANDLE = env(
    "HYPERCHARGE_BOUNTIES_PROFILE", default="gitcoinbot"
)
