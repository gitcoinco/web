...
urlpatterns = [
    path('grants/explorer', RedirectView.as_view(url='https://explorer.gitcoin.co/'), name='redirect_grants_explorer'),
    ...
    path('grants', RedirectView.as_view(url='https://grants.gitcoin.co'), name='redirect_grants_any'),
    ...
    path('settings', RedirectView.as_view(url='https://explorer.gitcoin.co/'), name='redirect_settings_any'),
    path('settings/<path:path>', RedirectView.as_view(url='https://explorer.gitcoin.co/'), name='redirect_settings_any'),
    path('bounties', RedirectView.as_view(url='https://app.buidlbox.io/bounty-explorer'), name='redirect_bounties_any'),
    path('bounties/<path:path>', RedirectView.as_view(url='https://app.buidlbox.io/bounty-explorer'), name='redirect_bounties_any'),
    path('bounty', RedirectView.as_view(url='https://app.buidlbox.io/bounty-explorer'), name='redirect_bounty_any'),
    path('bounty/<path:path>', RedirectView.as_view(url='https://app.buidlbox.io/bounty-explorer'), name='redirect_bounty_any'),
    path('hackathons', RedirectView.as_view(url='https://app.buidlbox.io/'), name='redirect_hackathons_any'),
    ...
    path('issue', RedirectView.as_view(url='https://app.buidlbox.io/bounty-explorer'), name='redirect_issue_any'),
    ...
    # Catch-all pattern
    re_path(r'^(?P<path>.*)$', RedirectView.as_view(url='https://gitcoin.co', permanent=False), name='catchall'),
