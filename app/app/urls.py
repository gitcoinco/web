...
urlpatterns = [
    ...
    url(
        ...
        dashboard.views.create_bounty_v1,
        name="create_bounty_v1",
    ),
    url(
        "^api/v1/bounty/cancel",
        dashboard.views.cancel_bounty_v1,
        name="cancel_bounty_v1",
    ),
    url(
        "^api/v1/bounty/fulfill",
        dashboard.views.fulfill_bounty_v1,
        name="fulfill_bounty_v1",
    ),
    path(
        "api/v1/bounty/<int:bounty_id>/close",
        dashboard.views.close_bounty_v1,
        name="close_bounty_v1",
    ),
    path(
        "api/v1/bounty/payout/<int:fulfillment_id>",
        dashboard.views.payout_bounty_v1,
        name="payout_bounty_v1",
    ),
    re_path(
        r".*api/v0.1/chat/presence$", chat.views.chat_presence, name="chat_presence"
    ),
    re_path(
        r".*api/v0.1/video/presence$",
        townsquare.views.video_presence,
        name="video_presence",
    ),
    # inbox
    ...
    re_path(
        r"^kudos/marketplace/?$", kudos.views.marketplace, name="kudos_marketplace"
    ),
    ...
    re_path(
        r"^lazy_load_kudos/$", dashboard.views.lazy_load_kudos, name="lazy_load_kudos"
    ),
    re_path(
    ...
    re_path(
        r"^kudos/redeem/(?P<secret>.*)/?$",
        kudos.views.receive_bulk,
    ...
    re_path(
        r"^kudos/(?P<kudos_id>\d+)/(?P<name>\w*)",
        kudos.views.details,
        name="kudos_details",
    ),
    re_path(
        r"^kudos/address/(?P<handle>.*)",
        kudos.views.kudos_preferred_wallet,
        name="kudos_preferred_wallet",
    ),
    re_path(
        r"^dynamic/kudos/(?P<kudos_id>\d+)/(?P<name>\w*)",
        kudos.views.image,
        name="kudos_dynamic_img",
    ),
    ...
    # api views
    url(
        r"^api/v0.1/profile/(.*)?/keywords",
        dashboard.views.profile_keywords,
        name="profile_keywords",
    ),
    url(
        r"^api/v0.1/profile/(.*)?/activity.json",
        dashboard.views.profile_activity,
        name="profile_activity",
    ),
    url(
        r"^api/v0.1/profile/(.*)?/earnings.csv",
        dashboard.views.profile_earnings,
        name="profile_earnings",
    ),
    url(
        r"^api/v0.1/profile/(.*)?/grants.csv",
        dashboard.views.profile_grants,
        name="profile_grants",
    ),
    url(
        r"^api/v0.1/profile/(.*)?/quests.csv",
        dashboard.views.profile_quests,
        name="profile_quests",
    ),
    url(
        r"^api/v0.1/profile/(.*)?/ratings/(.*).csv",
        dashboard.views.profile_ratings,
        name="profile_ratings",
    ),
    url(
        r"^api/v0.1/profile/(.*)?/viewers.csv",
        dashboard.views.profile_viewers,
        name="profile_viewers",
    ),
    url(
        r"^api/v0.1/profile/(.*)?/spent.csv",
        dashboard.views.profile_spent,
        name="profile_spent",
    ),
    url(
        r"^api/v0.1/profile/banner",
        dashboard.views.change_user_profile_banner,
        name="change_user_profile_banner",
    ),
    url(
        r"^api/v0.1/profile/settings",
        dashboard.views.profile_settings,
        name="profile_settings",
    ),
    url(
        r"^api/v0.1/profile/backup",
        dashboard.views.profile_backup,
        name="profile_backup",
    ),
    path(
        "api/v0.1/activity/<int:activity_id>",
        townsquare.views.api,
        name="townsquare_api",
    ),
    path(
        "api/v0.1/comment/<int:comment_id>",
        townsquare.views.comment_v1,
        name="comment_v1",
    ),
    path(
        "api/v0.1/emailsettings/",
        townsquare.views.emailsettings,
        name="townsquare_emailsettings",
    ),
    url(
        r"^api/v0.1/activity",
        retail.views.create_status_update,
    ...
    url(
        r"^api/v0.1/profile/(?P<handle>.*)",
        dashboard.views.profile_details,
        name="profile_details",
    ),
    url(
        r"^api/v0.1/user_card/(?P<handle>.*)",
        dashboard.views.user_card,
        name="user_card",
    ),
    url(r"^api/v0.1/banners", dashboard.views.load_banners, name="load_banners"),
    url(
        r"^api/v0.1/status_wallpapers",
        townsquare.views.load_wallpapers,
    ...
    url(
        r"^api/v0.1/choose_persona/",
        dashboard.views.choose_persona,
        name="choose_persona",
    ),
    # chat
    ...
    re_path(
        r"^onboard/contributor/avatar/?$",
        dashboard.views.onboard_avatar,
        name="onboard_avatar",
    ),
    ...
    # Funder dashboard
    path(
        "funder_dashboard/<str:bounty_type>/",
        dashboard.views.funder_dashboard,
        name="funder_dashboard",
    ),
    path(
    ...
    re_path(
        r"^quests/(?P<obj_id>\d+)/feedback",
        quests.views.feedback,
        name="quest_feedback",
    ),
    re_path(
        r"^quests/(?P<obj_id>\d+)/(?P<name>\w*)",
        quests.views.details,
        name="quest_details",
    ),
    ...
    path(
        "contributor_dashboard/<str:bounty_type>/",
        dashboard.views.contributor_dashboard,
        name="contributor_dashboard",
    ),
    # Hackathon static page
    url(r"^hackathon/ethhack2019", dashboard.views.ethhack, name="ethhack_2019"),
    url(
        r"^hackathon/beyondblocks",
        dashboard.views.beyond_blocks_2019,
        name="beyond_blocks_2019",
    ),
    path(
        "revenue/attestations/new",
        revenue.views.new_attestation,
        name="revenue_new_attestation",
    ),
    # Hackathons / special events
    path(
        "hackathon/<str:hackathon>/new/",
        dashboard.views.new_hackathon_bounty,
        name="new_hackathon_bounty",
    ),
    path(
        "hackathon/<str:hackathon>/new",
        dashboard.views.new_hackathon_bounty,
        name="new_hackathon_bounty2",
    ),
    path("hackathon/<str:hackathon>/", dashboard.views.hackathon, name="hackathon"),
    path(
        "hackathon/dashboard/<str:hackathon>",
    ...
    path(
        "hackathon/<str:hackathon>/onboard/",
        dashboard.views.hackathon_onboard,
        name="hackathon_onboard2",
    ),
    path(
        "hackathon/<str:hackathon>/<str:panel>/",
        dashboard.views.hackathon,
        name="hackathon",
    ),
    path(
        "hackathon/<str:hackathon>/onboard",
        dashboard.views.hackathon_onboard,
        name="hackathon_onboard",
    ),
    path(
        "hackathon/onboard/<str:hackathon>",
        dashboard.views.hackathon_onboard,
        name="hackathon_onboard2",
    ),
    path(
    ...
    path(
        "hackathon/<str:hackathon>/projects/",
        dashboard.views.hackathon_projects,
        name="hackathon_projects",
    ),
    path(
        "hackathon/<str:hackathon>/showcase/",
        dashboard.views.hackathon,
        name="hackathon_showcase_proxy",
    ),
    path(
        "hackathon/<str:hackathon>/prizes/",
        dashboard.views.hackathon,
        name="hackathon_prizes",
    ),
    path(
        "hackathon/<str:hackathon>/townsquare/",
        dashboard.views.hackathon,
        name="hackathon_ts",
    ),
    path(
    ...
    path(
        "modal/new_project/<int:bounty_id>/",
        dashboard.views.hackathon_get_project,
        name="hackathon_get_project",
    ),
    path(
    ...
    path(
        "modal/save_project/",
        dashboard.views.hackathon_save_project,
        name="hackathon_save_project",
    ),
    ...
    url(
        r"^hackathon/<str:hackathon>/?$/?", dashboard.views.hackathon, name="hackathon"
    ),
    url(
        r"^hackathon/<str:hackathon>/<str:panel>/?$/?",
        dashboard.views.hackathon,
        name="hackathon",
    ),
    ...
    url(
        r"^register_hackathon/",
        dashboard.views.hackathon_registration,
        name="hackathon_registration",
    ),
    path(
        "api/v0.1/hackathon/<str:hackathon>/save/",
        dashboard.views.save_hackathon,
        name="save_hackathon",
    ),
    path(
        "api/v1/hackathon/<str:hackathon>/prizes",
        dashboard.views.hackathon_prizes,
        name="hackathon_prizes_api",
    ),
    path(
        "api/v0.1/hackathon/<str:hackathon>/showcase/",
        dashboard.views.showcase,
        name="hackathon_showcase",
    ),
    path(
        "api/v0.1/projects/<int:project_id>",
        dashboard.views.get_project,
        name="project_context",
    ),
    # action URLs
    url(
        r"^funder",
        retail.views.funder_bounties_redirect,
        name="funder_bounties_redirect",
    ),
    re_path(
    ...
    re_path(
        r"^bounties/contributor/?(?P<tech_stack>.*)/?",
        retail.views.contributor_bounties,
    ...
    re_path(
        r"^bounty/change/(?P<bounty_id>.*)?",
        dashboard.views.change_bounty,
        name="change_bounty",
    ),
    url(
        r"^funding/new/?", dashboard.views.new_bounty, name="new_funding"
    ),  # TODO: Remove
    url(
        r"^new/?", dashboard.views.new_bounty, name="new_funding_short"
    ),  # TODO: Remove
    ...
    path(
        "issue/advanced_payout",
        dashboard.views.bulk_payout_bounty,
        name="bulk_payout_bounty",
    ),
    ...
    path(
        "modal/social_contribution",
        dashboard.views.social_contribution_modal,
        name="social_contribution_modal",
    ),
    path(
    ...
    # Rating
    path(
        "modal/rating/<int:bounty_id>/<str:username>",
        dashboard.views.rating_modal,
        name="rating_modal2",
    ),
    path(
        "modal/rating/<int:bounty_id>/<str:username>/",
    ...
    path(
        "modal/rating_capture/", dashboard.views.rating_capture, name="rating_capture"
    ),
    url(
        r"^api/v0.1/unrated_bounties/",
        dashboard.views.unrated_bounties,
        name="unrated_bounties",
    ),
    ...
    # Interests
    path(
        "actions/bounty/<int:bounty_id>/interest/new/",
        dashboard.views.new_interest,
        name="express-interest",
    ),
    path(
        "actions/bounty/<int:bounty_id>/interest/remove/",
    ...
    re_path(
        r"^funding/details/?", dashboard.views.bounty_details, name="funding_details"
    ),
    re_path(
        r"^issue/(?P<invitecode>.*)",
        dashboard.views.bounty_invite_url,
        name="unique_bounty_invite",
    ),
    # Tips
    url(
    ...
    url(
        r"^tip/address/(?P<handle>.*)",
        dashboard.tip_views.tipee_address,
        name="tipee_address",
    ),
    ...
    re_path(
        r"^user_directory/?",
        dashboard.views.users_directory_elastic,
        name="users_directory_elastic",
    ),
    re_path(
        r"^user_lookup/?", dashboard.views.user_lookup, name="user_directory_lookup"
    ),
    re_path(
        r"^tribes/explore", dashboard.views.users_directory, name="tribes_directory"
    ),
    # Alpha functionality
    ...
    url(
        r"^gas/calculator/?", dashboard.gas_views.gas_calculator, name="gas_calculator"
    ),
    url(
        r"^gas/history/?", dashboard.gas_views.gas_history_view, name="gas_history_view"
    ),
    url(
        r"^gas/guzzlers/?",
        dashboard.gas_views.gas_guzzler_view,
        name="gas_guzzler_view",
    ),
    ...
    re_path(
        r"^dynamic/avatar/(.*)/(.*)?", avatar.views.handle_avatar, name="org_avatar"
    ),
    ...
    re_path(
        r"^dynamic/viz/sscatterplot/(.*)?$",
        dataviz.d3_views.viz_scatterplot_stripped,
        name="viz_sscatterplot",
    ),
    ...
    re_path(
        r"^sync/get_issue_details/?",
        dashboard.helpers.issue_details,
        name="helpers_issue_details",
    ),
    # modals
    re_path(
        r"^modal/get_quickstart_video/?",
        dashboard.views.get_quickstart_video,
        name="get_quickstart_video",
    ),
    re_path(
        r"^modal/extend_issue_deadline/?",
    ...
    re_path(
        r"^results/?(?P<keyword>.*)/?", retail.views.results, name="results_by_keyword"
    ),
    ...
    path(
        "action/<int:offer_id>/<slug:offer_slug>/go",
        townsquare.views.offer_go,
        name="townsquare_offer_go",
    ),
    ...
    path(
        "action/<int:offer_id>/<slug:offer_slug>",
        townsquare.views.offer_view,
        name="townsquare_offer_view",
    ),
    url(
        r"^service/metadata/$",
        townsquare.views.extract_metadata_page,
        name="meta-extractor",
    ),
    ...
    url(
        r"^extension/chrome/?",
        retail.views.browser_extension_chrome,
        name="browser_extension_chrome",
    ),
    url(
        r"^extension/firefox/?",
        retail.views.browser_extension_firefox,
        name="browser_extension_firefox",
    ),
    url(
        r"^extension/?", retail.views.browser_extension_chrome, name="browser_extension"
    ),
    ...
    re_path(
        r"^whitepaper/accesscode/?",
        tdi.views.whitepaper_access,
    ...
    # bounty requests
    re_path(
        r"^requests/?", bounty_requests.views.bounty_request, name="bounty_requests"
    ),
    url(
    ...
    path(
        "_administration/email/kudos_mint", retail.emails.kudos_mint, name="kudos_mint"
    ),
    path("_administration/email/kudos_mkt", retail.emails.kudos_mkt, name="kudos_mkt"),
    path(
        "_administration/email/new_bounty",
        retail.emails.new_bounty,
        name="admin_new_bounty",
    ),
    path("_administration/email/roundup", retail.emails.roundup, name="roundup"),
    path(
        "_administration/email/faucet_rejected",
        retail.emails.faucet_rejected,
        name="email_faucet_rejected",
    ),
    ...
    path(
        "_administration/email/quarterly_roundup",
        retail.emails.quarterly_roundup,
        name="quarterly_roundup",
    ),
    path(
        "_administration/email/new_work_submission",
        retail.emails.new_work_submission,
        name="new_work_submission",
    ),
    path(
        "_administration/email/weekly_founder_recap",
        retail.emails.weekly_recap,
        name="weekly_founder_recap",
    ),
    path(
    ...
    path(
        "_administration/email/wallpost", retail.emails.wallpost, name="wallpost_email"
    ),
    path(
        "_administration/email/grant_update",
        retail.emails.grant_update,
        name="grant_update_email",
    ),
    path(
        "_administration/email/grant_recontribute",
        retail.emails.grant_recontribute,
        name="grant_recontribute_email",
    ),
    path(
        "_administration/email/grant_txn_failed",
        retail.emails.grant_txn_failed,
        name="grant_txn_failed_email",
    ),
    path(
    ...
    path(
        "_administration/email/bounty_feedback",
        retail.emails.bounty_feedback,
        name="bounty_feedback",
    ),
    path(
        "_administration/email/funder_stale",
        retail.emails.funder_stale,
        name="funder_stale",
    ),
    path(
    ...
    path(
        "_administration/email/start_work_expired",
        retail.emails.start_work_expired,
        name="start_work_expired",
    ),
    path(
        "_administration/email/gdpr_reconsent",
        retail.emails.gdpr_reconsent,
        name="gdpr_reconsent",
    ),
    path(
        "_administration/email/share_bounty",
        retail.emails.share_bounty,
        name="share_bounty",
    ),
    path(
        "_administration/email/new_tip/resend",
        retail.emails.resend_new_tip,
        name="resend_new_tip",
    ),
    path(
    ...
    re_path(
        r"^_administration/email/start_work_approved$",
        retail.emails.start_work_approved,
        name="start_work_approved",
    ),
    re_path(
        r"^_administration/email/start_work_rejected$",
        retail.emails.start_work_rejected,
        name="start_work_rejected",
    ),
    re_path(
    ...
    re_path(
        r"^settings/email/(.*)", marketing.views.email_settings, name="email_settings"
    ),
    re_path(
        r"^settings/privacy/?",
        marketing.views.privacy_settings,
        name="privacy_settings",
    ),
    re_path(
        r"^settings/matching/?",
        marketing.views.matching_settings,
        name="matching_settings",
    ),
    re_path(
        r"^settings/feedback/?",
        marketing.views.feedback_settings,
        name="feedback_settings",
    ),
    re_path(
        r"^settings/slack/?", marketing.views.slack_settings, name="slack_settings"
    ),
    re_path(
        r"^settings/account/?",
        marketing.views.account_settings,
        name="account_settings",
    ),
    re_path(
        r"^settings/tokens/?", marketing.views.token_settings, name="token_settings"
    ),
    re_path(r"^settings/job/?", marketing.views.job_settings, name="job_settings"),
    re_path(
        r"^settings/organizations/?", marketing.views.org_settings, name="org_settings"
    ),
    ...
    re_path(
        r"^_administration/mesh/?$",
        dataviz.d3_views.mesh_network_viz,
        name="mesh_network_viz",
    ),
    re_path(
        r"^_administration/viz/sunburst/(.*)?$",
        dataviz.d3_views.viz_sunburst,
        name="viz_sunburst",
    ),
    re_path(
        r"^_administration/viz/chord/(.*)?$",
        dataviz.d3_views.viz_chord,
        name="viz_chord",
    ),
    re_path(
        r"^_administration/viz/steamgraph/(.*)?$",
        dataviz.d3_views.viz_steamgraph,
        name="viz_steamgraph",
    ),
    re_path(
        r"^_administration/viz/circles/(.*)?$",
        dataviz.d3_views.viz_circles,
        name="viz_circles",
    ),
    re_path(
        r"^_administration/viz/sankey/(.*)?$",
        dataviz.d3_views.viz_sankey,
        name="viz_sankey",
    ),
    re_path(
        r"^_administration/viz/spiral/(.*)?$",
        dataviz.d3_views.viz_spiral,
        name="viz_spiral",
    ),
    re_path(
        r"^_administration/viz/heatmap/(.*)?$",
        dataviz.d3_views.viz_heatmap,
        name="viz_heatmap",
    ),
    re_path(
        r"^_administration/viz/calendar/(.*)?$",
        dataviz.d3_views.viz_calendar,
        name="viz_calendar",
    ),
    re_path(
        r"^_administration/viz/draggable/(.*)?$",
        dataviz.d3_views.viz_draggable,
        name="viz_draggable",
    ),
    re_path(
        r"^_administration/viz/scatterplot/(.*)?$",
        dataviz.d3_views.viz_scatterplot,
        name="viz_scatterplot",
    ),
    ...
    # Interests
    path(
        "interest/modal", dashboard.views.get_interest_modal, name="get_interest_modal"
    ),
    path(
        "actions/bounty/<int:bounty_id>/interest/new/",
        dashboard.views.new_interest,
    ...
    path(
        settings.SENDGRID_EVENT_HOOK_URL,
        marketing.webhookviews.process,
        name="sendgrid_event_process",
    ),
    # gitcoinbot
    url(settings.GITHUB_EVENT_HOOK_URL, gitcoinbot.views.payload, name="payload"),
    url(r"^impersonate/", include("impersonate.urls")),
    url(
        r"^api/v0.1/hackathon_project/set_winner/",
        dashboard.views.set_project_winner,
        name="project_winner",
    ),
    url(
        r"^api/v0.1/hackathon_project/set_notes/",
        dashboard.views.set_project_notes,
        name="project_notes",
    ),
    # users
    url(
        r"^api/v0.1/user_bounties/",
        dashboard.views.get_user_bounties,
        name="get_user_bounties",
    ),
    url(r"^api/v0.1/users_csv/", dashboard.views.output_users_to_csv, name="users_csv"),
    url(
        r"^api/v0.1/bounty_mentor/", dashboard.views.bounty_mentor, name="bounty_mentor"
    ),
