...
urlpatterns = [
    ...
    path('toolbox', dashboard.views.toolbox, name='toolbox'),
    ...
    # brochureware views
    path('about', retail.views.about, name='about'),
    path('mission', retail.views.mission, name='mission'),
    path('vision', retail.views.vision, name='vision'),
    path('not_a_token', retail.views.not_a_token, name='not_a_token'),
    path('styleguide-alpha', retail.views.ui, name='ui'),
    ...
    path('presskit', retail.views.presskit, name='presskit'),
    path('community', retail.views.community, name='community'),
    path('slack', retail.views.slack, name='slack'),
    path('submittoken', retail.views.newtoken, name='newtoken'),
    path('iosfeedback', retail.views.iosfeedback, name='iosfeedback'),
    path('ios', retail.views.ios, name='ios'),
    path('itunes', retail.views.itunes, name='itunes'),
    path('podcast', retail.views.podcast, name='podcast'),
    path('casestudies', retail.views.casestudy, name='casestudies'),
    path('schwag', retail.views.schwag, name='schwag'),
    path('btctalk', retail.views.btctalk, name='btctalk'),
    path('reddit', retail.views.reddit, name='reddit'),
    path('livestream', retail.views.livestream, name='livestream'),
    path('feedback', retail.views.feedback, name='feedback'),
    path('twitter', retail.views.twitter, name='twitter'),
    path('gitter', retail.views.gitter, name='gitter'),
    path('fb', retail.views.fb, name='fb'),
    path('medium', retail.views.medium, name='medium'),
    path('github', retail.views.github, name='github'),
    path('youtube', retail.views.youtube, name='youtube'),
    path('web3', retail.views.web3, name='web3'),
