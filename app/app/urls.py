...
urlpatterns = [
    ...
    re_path(r'^jtbd/earn/?$', retail.views.jtbd_earn, name='jtbd_earn'),
    re_path(r'^jtbd/learn/?$', retail.views.jtbd_learn, name='jtbd_learn'),
    re_path(r'^jtbd/connect/?$', retail.views.jtbd_connect, name='jtbd_connect'),
    re_path(r'^jtbd/fund/?$', retail.views.jtbd_fund, name='jtbd_fund'),
