...
urlpatterns = [
    ...
    path('ideas/', retail.views.ideas_list, name='ideas_list'),
    path('ideas/idea/<int:idea_id>', retail.views.idea_show, name='idea_show'),
    path('ideas/idea/<int:idea_id>/get', retail.views.idea_get, name='idea_get'),
