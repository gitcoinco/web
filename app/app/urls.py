...
urlpatterns = [
    ...
    path('kudos/send/', kudos.views.send_kudos_2, name='kudos_send'),
    path('kudos/send/3/', kudos.views.send_kudos_3, name='kudos_send_3'),
    path('kudos/send/4/', kudos.views.send_kudos_4, name='kudos_send_4'),
