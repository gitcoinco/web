...
urlpatterns = [
    ...
    url(r'^addon/?', retail.views.firefox_addon, name='firefox_addon'),
    url(r'^firefox?', retail.views.firefox_addon, name='firefox_addon'),
    url(r'^extension/?', retail.views.chrome_extension, name='chrome_extension'),
    url(r'^chrome?', retail.views.chrome_extension, name='chrome_extension'),
