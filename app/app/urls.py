...
urlpatterns = [
    ...
    url(r'^tip/townsquare/send/4/?', dashboard.tip_views.send_tip_townsquare_4, name='send_tip_townsquare_4'),
    url(r'^tip/townsquare/send/3/?', dashboard.tip_views.send_tip_townsquare_3, name='send_tip_townsquare_3'),
