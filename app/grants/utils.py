...
from dashboard.models import Activity, Bounty, UserAction, Grant, Subscription, Contribution
...
class GrantNotFoundException(Exception):
    pass
...
# we will need to work this out since there are N Subscription contracts
def getSubscriptionContractAddresss(network):
    if network == 'mainnet':
