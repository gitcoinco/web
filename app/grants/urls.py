...
urlpatterns = [
    ...
    path(
        "zksync-set-interrupt-status",
        zksync_set_interrupt_status,
        name="zksync_set_interrupt_status",
    ),
    path(
        "zksync-get-interrupt-status",
        zksync_get_interrupt_status,
        name="zksync_get_interrupt_status",
    ),
    ...
    re_path(
        r"^matching-partners/new", new_matching_partner, name="new_matching_partner"
    ),
    path(
    ...
    path(
        "v1/api/collections/<int:collection_id>", get_collection, name="get_collection"
    ),
    path(
        "v1/api/collections/<int:collection_id>/grants/add",
        add_grant_from_collection,
        name="add_grant",
    ),
    path(
        "v1/api/collections/<int:collection_id>/grants/remove",
        remove_grant_from_collection,
        name="remove_grant",
    ),
