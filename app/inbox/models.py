...
class Notification(SuperModel):
    ...
    cta_text = models.CharField(max_length=50, choices=NOTIFICATION_TYPES)
    message_html = models.CharField(
        max_length=2000, blank=True, help_text=_("Html message")
    )
    ...
    from_user = models.ForeignKey(
        get_user_model(), on_delete=models.CASCADE, related_name="sent_notifications"
    )
