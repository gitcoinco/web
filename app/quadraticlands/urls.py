...
urlpatterns = [
    ...
    re_path(r'^(?P<base>about|leaderboard|privacy|terms-of-service|mission_knowledge_intro|dashboard|faq|web3|particletest|particletest2)$', base, name='quadraticlands_base'),
