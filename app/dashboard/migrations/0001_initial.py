    ...
    operations = [
                    ...
                    models.CharField(
                        ...
                        choices=[
                            ...
                            (
                                ...
                                "Warning for Abandonment of Bounty",
                            ),
                            (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "web3_type",
                    models.CharField(default="bounties_network", max_length=50),
                ),
                ("title", models.CharField(max_length=255)),
                ("web3_created", models.DateTimeField(db_index=True)),
                (
                    "value_in_token",
                    models.DecimalField(decimal_places=2, default=1, max_digits=50),
                ),
                ...
                (
                    "is_open",
                    models.BooleanField(
                        help_text="Whether the bounty is still open for fulfillments."
                    ),
                ),
                ...
                (
                    ...
                    models.TextField(
                        blank=True, default="", verbose_name="Cancelation reason"
                    ),
                ),
                (
                    "project_type",
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Admin override to hide the bounty from the system",
                    ),
                ),
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Admin override to suspend work auto approvals",
                    ),
                ),
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Admin override to mark as remarketing ready",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "issue_message",
                    models.TextField(
                        blank=True, default="", verbose_name="Issue Comment"
                    ),
                ),
                (
                    "pending",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.DecimalField(decimal_places=2, default=500, max_digits=50),
                ),
                (
                    "max_tip_amount_usdt_per_week",
                    models.DecimalField(decimal_places=2, default=1500, max_digits=50),
                ),
                (
                    "avatar",
                    models.ForeignKey(
