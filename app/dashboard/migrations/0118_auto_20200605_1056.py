# Generated by Django 2.2.4 on 2020-06-05 10:56
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            model_name='question',
            name='hook',
            field=models.CharField(choices=[('NO_ACTION', 'No trigger any action'), ('TOWNSQUARE_INTRO', 'Create intro on Townsquare')], default='NO_ACTION', max_length=50),
        ),
