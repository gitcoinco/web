...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument(
            "from_name", default="from_name", type=str, help="from_username, eg: owocki"
        )
        parser.add_argument(
            "usernames",
            default="usernames",
        ...
        parser.add_argument(
            "comments_priv", default="comments_priv", type=str, help="private comments"
        )
