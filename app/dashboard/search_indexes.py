...
class UserDirectoryIndex(indexes.SearchIndex, indexes.Indexable):
    ...
    which_hacks_joined = indexes.CharField(null=True,model_attr='which_hacks_joined',faceted=True)
    ...
    keywords = indexes.CharField(null=True,model_attr='keywords',faceted=True)
