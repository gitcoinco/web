...
def getStandardBountiesContractAddresss(network, contract_version='1.0'):
...
def getBountyContract(network, contract_version='1.0'):
...
def get_bounty(bounty_enum, network, contract_version='1.0'):
...
def get_bounty_id(issue_url, network, contract_version='1.0'):
    ...
    try:
        ...
        bounty_id = get_bounty_id_from_web3(issue_url, network, highest_known_bounty_id, direction='down', contract_version=contract_version)
        ...
        bounty_id = get_bounty_id_from_web3(issue_url, network, last_known_bounty_id, direction='up', contract_version=contract_version)
...
def get_bounty_id_from_web3(issue_url, network, start_bounty_id, direction='up', contract_version='1.0'):
    issue_url = normalize_url(issue_url)
