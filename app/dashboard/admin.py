# -*- coding: utf-8 -*-
"""Define the admin for the dashboard app.
...
class BountyFulfillmentAdmin(admin.ModelAdmin):
    ...
    search_fields = [
        'fulfiller_address', 'fulfiller_email', 'fulfiller_github_username', 'fulfiller_name', 'fulfiller_metadata',
...
class BountyAdmin(admin.ModelAdmin):
    ...
    def fulfillments_link(self, instance):
        ...
        url = f'/_administration/dashboard/bountyfulfillment/?bounty={instance.pk}'
        return mark_safe(f"<a href={url}>{copy}</a>")

    def standard_bounties_id_link(self, instance):
        copy = f'{instance.standard_bounties_id}'
        url = f'/_administration/dashboard/bounty/?standard_bounties_id={instance.standard_bounties_id}'
        return mark_safe(f"<a href={url}>{copy}</a>")
    ...
    def network_link(self, instance):
        ...
        url = f'/_administration/dashboard/bounty/?network={instance.network}'
        return mark_safe(f"<a href={url}>{copy}</a>")
