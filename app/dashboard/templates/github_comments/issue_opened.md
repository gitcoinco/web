...
Funding: {{ bounty.get_natural_value|floatformat:2|intcomma }} {{ bounty.token_name }} {{ bounty.get_value_in_usdt_now|floatformat:2|intcomma }} USD @ $ {{ token_value_in_usdt_now|floatformat:2|intcomma }}/{{ bounty.token_name }}
{% endif %}
