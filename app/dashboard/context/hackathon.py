...
eth_hack = {
    ...
    "meta_description": _(
        "Ethereal Virtual Hackathon, powered by Gitcoin and Microsoft"
    ),
    ...
    "powered_by": [
        {"name": "gitcoin", "logo": static("v2/images/top-bar/gitcoin-logo.svg")},
        {"name": "eth", "logo": static("v2/images/hackathon/ethhack/microsoft.svg")},
    ],
    ...
    "results_link": _(
        "https://medium.com/gitcoin/the-results-msft-gitcoins-ethereal-hackathon-30f5ed05757e"
    ),
    "starter_guide": _(
    ...
    "sections": [
        ...
        },
        {
            ...
            "bg": "hk-blue-bg",
            "subtitle": _(
                "Have an epic challenge you want to see the community tackle? <br> Registrations are CLOSED for this hackathon, <br> but you can sign up for our next hackathon below."
            ),
...
beyond_blocks_2019 = {
    ...
    "meta_description": _(
        "Beyond Blocks Hackathon, powered by Gitcoin and Consensys Labs"
    ),
    ...
    "sections": [
        ...
        },
        {
            ...
            "font-bg-color": "hk-white-f",
            "subtitle": _(
                'Have an epic challenge you want to see the community tackle? <br> <a target="_blank" href="https://docs.google.com/presentation/d/1gktma0VzSmzLGKFLJ7xVEbkXHjHfroP2Rk9vrYUIv_k/edit#slide=id.g5b466f0de5_1_6">Learn More</a>'
            ),
            "img": static("v2/images/hackathon/bot.svg"),
        },
    ],
