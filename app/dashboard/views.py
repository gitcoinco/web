...
def profile(request, handle):
    ...
    owned_kudos = Listing.objects.filter(owner_address__in=params['wallet_addresses'])
    sent_kudos = Listing.objects.filter(sent_from_address__in=params['wallet_addresses'])
    # if owned_kudos:
