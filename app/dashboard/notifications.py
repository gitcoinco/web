...
def build_github_notification(bounty, event_name, profile_pairs=None):
    ...
    funding_organisation_brand = f"__ as part of the {bounty.funding_organisation} fund" if bounty.funding_organisation else ""
    if crowdfund_thx:
    ...
    if event_name == 'new_bounty':
        msg = f"{status_header}__This issue now has a funding of {natural_value} {bounty.token_name} {usdt_value} " \
              f"{crowdfund_amount} attached to it{funding_organisation_brand}.__\n\n * If you would " \
