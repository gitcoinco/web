...
def start():
    ...
    Token.objects.create(
        symbol="E18R",
        address="0xFc1079D41D56D78e9FA2a857991F41D777104c74",
        network="mainnet",
    )
...
def profile():
    profile, created = Profile.objects.get_or_create(
        data={}, handle="e18r", email="e18r@localhost"
    )
    return profile
...
def cancelled_subscription(new_subscription):
    new_subscription.end_approve_tx_id = (
        "0xa95d30415427f76c778207e789c78d436b5c4ca4339797cff52ed21de8419554"
    )
    new_subscription.cancel_tx_id = (
        "0xa95d30415427f76c778207e789c78d436b5c4ca4339797cff52ed21de8419554"
    )
...
def test_avoid_duplicate_cancelled_subscription_activity(
    cancelled_subscription_with_activity,
):
    ...
    assert (
        len([a for a in activities if a.activity_type == "killed_grant_contribution"])
        == 1
    )
