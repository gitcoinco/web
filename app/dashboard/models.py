...
class Bounty(SuperModel):
    ...
    bounty_owner_name = models.CharField(max_length=255, null=True)
    claimeee_address = models.CharField(max_length=50)
    claimee_email = models.CharField(max_length=255, null=True, blank=True)
    claimee_github_username = models.CharField(max_length=255, null=True, blank=True)
    claimee_name = models.CharField(max_length=255, null=True)
