...
class Bounty(SuperModel):
    ...
    opened_comment = models.IntegerField(null=True, blank=True)
    interested_comment = models.IntegerField(null=True, blank=True)
    started_comment = models.IntegerField(null=True, blank=True)
    stopped_comment = models.IntegerField(null=True, blank=True)
    submissions_comment = models.IntegerField(null=True, blank=True)
    done_comment = models.IntegerField(null=True, blank=True)
