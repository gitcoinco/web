...
def get_github_idx_verification():
# When this request is made the service stores the did, username, and a timestamp in it's database of requested github verifications.
    requestURL = settings.CERAMIC_URL + '/api/v0/request-github'
    return requestURL

def get_twitter_idx_verification():
    requestURL = settings.CERAMIC_URL + '/api/v0/request-twitter'
    return requestURL
