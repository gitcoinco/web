...
class GitcoinBotActionsTest(TestCase):
    ...
    def test_help_text(self):
        ...
        target_text = (
            f"I am @{settings.GITHUB_API_USER}, a bot that facilitates gitcoin bounties.\n\n<hr>"
    ...
    def test_new_bounty_text(self):
        ...
        target_text = (
            "To create the bounty please [visit this link]"
    ...
    def test_parse_comment_currency(self):
        ...
        )  # Default behavior should fallback to DEFAULT_CURRENCY
        ...
        self.assertEqual(
            currency3, FALLBACK_CURRENCY
        )  # Unknown currency should fallback to DEFAULT_CURRENCY
    ...
    def test_new_tip_text(self):
        ...
        target_text = (
            f"To complete the tip, please [visit this link]({tip_link}).\n "
            "PS Make sure you're logged into Metamask!"
        )
    ...
    def test_submit_work_text(self):
        ...
        target_text = (
            f"To finish claiming this bounty please [visit this link]({submit_link})"
        )
    ...
    def test_submit_work_or_new_bounty_when_bounty_doesnt_exist(self):
        ...
        target_text = (
            "No active bounty for this issue, consider create the bounty please"
    ...
    def test_get_text_from_responses_when_exists(self):
        ...
        GitcoinBotResponses.objects.create(
            request="speedy gonzales", response="The Fastest Mouse in all Mexico"
        )
