...
def help_text():
    ...
    help_text_response = (
        f"I am {github_bot_user}, a bot that facilitates gitcoin bounties.\n"
...
def new_bounty_text(owner, repo, issue_id, comment_text):
    ...
    new_bounty_response = (
        f"To create the bounty please [visit this link]({bounty_link}).\n\n "
...
def start_work_text(owner, repo, issue_id):
    ...
    start_work_response = (
        f"To show this bounty as started please [visit this link]({start_work_link})"
    )
...
def determine_response(
    owner, repo, comment_id, comment_text, issue_id, install_id, sender
):
