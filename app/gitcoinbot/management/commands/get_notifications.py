                ...
                if (
                    ...
                    try:
                        ...
                        comment = get_issue_comments(
                            _org_name, _repo_name, _issue_number, _comment_id
                        )
                        does_mention_gitcoinbot = (
                            settings.GITHUB_API_USER in comment.get("body", "")
                        )
                        if comment.get("message", "") == "Not Found":
                            ...
                            is_from_gitcoinbot = (
                                settings.GITHUB_API_USER in comment_from
                            )
