...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        contributor_profiles = Profile.objects.filter(
            grant_contributor__subscription_contribution__success=True,
            grant_contributor__subscription_contribution__created_on__gte=datetime.datetime(
                *prev_round_start
            ),
            grant_contributor__subscription_contribution__created_on__lte=datetime.datetime(
                *prev_round_end
            ),
        ).distinct()
