...
from retail.emails import (
    render_admin_contact_funder, render_bounty_added_to_event, render_bounty_changed, render_bounty_expire_warning,
    render_bounty_feedback, render_bounty_not_submitted, render_bounty_request, render_bounty_startwork_expire_warning,
    ...
    render_gdpr_update, render_grant_cancellation_email, render_grant_update, render_hackathon_end, render_kudos_email,
