...
from retail.emails import (
    ...
    render_change_grant_owner_reject, render_change_grant_owner_request, render_failed_transaction_email,
    render_faucet_rejected, render_faucet_request, render_funder_stale, render_gdpr_reconsent, render_gdpr_update,
