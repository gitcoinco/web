...
export PGPASSWORD=$(cat app/app/.env | grep "DATABASE_URL" | awk -F "=" '{print $2}' | awk -F "@" '{print $2}' | awk -F ":" '{print $1}')
export HOST=$(cat app/app/.env | grep "DATABASE_URL" | awk '{print $2}' | sed "s/'//g" | sed "s/,//g")
