...
if [ ! -f /provisioned ] || [ "$FORCE_PROVISION" = "on" ]; then
    ...
    if [ "$DISABLE_INITIAL_LOADDATA" != "on" ]; then
        ...
        manage.py loaddata app/app/fixtures/users.json
        manage.py loaddata app/app/fixtures/economy.json
        manage.py loaddata app/app/fixtures/profiles.json
        manage.py loaddata app/app/fixtures/kudos.json
        manage.py loaddata app/app/fixtures/grants.json
        manage.py loaddata app/app/fixtures/dashboard.json
        manage.py loaddata app/app/fixtures/avatar.json
        manage.py loaddata app/app/fixtures/marketing.json
        manage.py loaddata app/app/fixtures/profiles.json
        manage.py loaddata app/app/fixtures/grants.json
