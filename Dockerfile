...
ARG PACKAGES="postgresql-libs libxml2 libxslt freetype libffi jpeg libmaxminddb bash git tar gzip inkscape libmagic gcc musl-dev linux-headers openblas-dev lapack g++"
