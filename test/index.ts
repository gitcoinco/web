...
const checkWrongDirectoryItem = (directory, filename) => {
  ...
  if (directory === './erc20') {
    ...
    if (['bitcoin.png', 'eos.png', 'ethereum.png', 'omni_31.png', 'atom.png', 'cosmos.png', 'litecoin.png','tron.png','bitcoincash.png','nervos.png','polkadot.png','westend.png','kusama.png','filecoin.png'].indexOf(filename) === -1 &&
